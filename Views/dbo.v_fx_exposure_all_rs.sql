...
GO
GRANT SELECT ON  [dbo].[v_fx_exposure_all_rs] TO [public]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'VIEW', N'v_fx_exposure_all_rs', NULL, NULL
GO
