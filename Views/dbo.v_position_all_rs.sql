...
select
   ...
   maintb.equiv_source_ind,
   maintb.mkt_long_qty,
   maintb.mkt_short_qty,
   maintb.sec_mkt_long_qty,
   maintb.sec_mkt_short_qty,
   it.type,
   it.user_init,
   it.tran_date,
   it.app_name,
...
select
   ...
   audtb.equiv_source_ind,
   audtb.mkt_long_qty,
   audtb.mkt_short_qty,
   audtb.sec_mkt_long_qty,
   audtb.sec_mkt_short_qty,
   it.type,
   it.user_init,
   it.tran_date,
   it.app_name,
