...
GO
GRANT SELECT ON  [dbo].[v_aud_allocation_item_rs] TO [public]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'VIEW', N'v_aud_allocation_item_rs', NULL, NULL
GO
