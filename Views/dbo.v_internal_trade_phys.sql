...
CREATE view [dbo].[v_internal_trade_phys]  
(  
contr_date,   
trade_num,  
order_num,  
...
GO
GRANT SELECT ON  [dbo].[v_internal_trade_phys] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'VIEW', N'v_internal_trade_phys', NULL, NULL
GO
