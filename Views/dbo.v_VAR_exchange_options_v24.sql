...
GO
GRANT SELECT ON  [dbo].[v_VAR_exchange_options_v24] TO [admin_group]
GO
GRANT SELECT ON  [dbo].[v_VAR_exchange_options_v24] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'VIEW', N'v_VAR_exchange_options_v24', NULL, NULL
GO
