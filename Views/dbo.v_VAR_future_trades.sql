...
CREATE view [dbo].[v_VAR_future_trades]
(
   trade_num, 
   order_num, 
   item_num, 
...
GO
GRANT SELECT ON  [dbo].[v_VAR_future_trades] TO [admin_group]
GO
GRANT SELECT ON  [dbo].[v_VAR_future_trades] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'VIEW', N'v_VAR_future_trades', NULL, NULL
GO
