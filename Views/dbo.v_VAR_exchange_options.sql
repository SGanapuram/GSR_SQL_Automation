...
CREATE view [dbo].[v_VAR_exchange_options]
(
   trade_num,
   order_num,
   item_num,
...
GO
GRANT SELECT ON  [dbo].[v_VAR_exchange_options] TO [admin_group]
GO
GRANT SELECT ON  [dbo].[v_VAR_exchange_options] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'VIEW', N'v_VAR_exchange_options', NULL, NULL
GO
