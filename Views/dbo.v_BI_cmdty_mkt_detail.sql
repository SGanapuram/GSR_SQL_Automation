...
SET ANSI_NULLS ON
GO
CREATE view [dbo].[v_BI_cmdty_mkt_detail]        
(        
commkt_key,         
cmdty_code,        
cmdty_short_name,         
...
GO
GRANT SELECT ON  [dbo].[v_BI_cmdty_mkt_detail] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'VIEW', N'v_BI_cmdty_mkt_detail', NULL, NULL
GO
