...
basis_cmdty_code DataTypeCode,                     
cmdty.cmdty_short_name DataTypeDesc ,                    
convert(nvarchar(max),fc.price_quote_string) 'Formula',  NULL,                  
...
--LEFT OUTER JOIN formula_component cc on fc.formula_num = cc.formula_num and fc.formula_body_num = cc.formula_body_num and cc.formula_comp_type = 'U'                     
INNER JOIN v_BI_cmdty_mkt_detail cmdty On cmdty.cmdty_code=fc.basis_cmdty_code    and cmdty.mkt_code=fc.risk_mkt_code                
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'VIEW', N'v_get_conc_trade_detail', NULL, NULL
GO
