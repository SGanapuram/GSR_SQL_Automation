...
CREATE procedure [dbo].[fetchCostToChildCost]
(
   @asof_trans_id        int,
   @cost_num              int
)
...
set nocount on
   ...
   select acct_num,
          ...
          vc_acct_num
   from dbo.cost
   where parent_cost_num = @cost_num and
...
return
GO
GRANT EXECUTE ON  [dbo].[fetchCostToChildCost] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'fetchCostToChildCost', NULL, NULL
GO
