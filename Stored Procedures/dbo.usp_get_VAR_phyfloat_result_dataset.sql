...
declare @sql                    varchar(max),
   ...
   create nonclustered index xx0191_phyfloat_idx1
      on #phyfloat (trade_num, order_num, item_num)

   create nonclustered index xx0191_phyfloat_idx2
      on #phyfloat (real_synth_ind)
	       include (trade_num, order_num, item_num, dist_qty, alloc_qty, qty_uom_code)
