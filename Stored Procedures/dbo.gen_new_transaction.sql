...
GO
GRANT EXECUTE ON  [dbo].[gen_new_transaction] TO [admin_group]
GO
GRANT EXECUTE ON  [dbo].[gen_new_transaction] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'gen_new_transaction', NULL, NULL
GO
