...
CREATE procedure [dbo].[fetchTradeItemToTradeItem]
(
   @asof_trans_id   int,
   @order_num       smallint,
   @parent_item_num smallint,
   @trade_num       int
)
as
set nocount on
...
where trade_num = @trade_num and 
      ...
      parent_item_num = @parent_item_num and 
...
return
GO
GRANT EXECUTE ON  [dbo].[fetchTradeItemToTradeItem] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'fetchTradeItemToTradeItem', NULL, NULL
GO
