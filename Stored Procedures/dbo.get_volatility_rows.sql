...
CREATE procedure [dbo].[get_volatility_rows]
(
...
return
GO
GRANT EXECUTE ON  [dbo].[get_volatility_rows] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'get_volatility_rows', NULL, NULL
GO
