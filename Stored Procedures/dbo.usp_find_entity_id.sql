...
GO
GRANT EXECUTE ON  [dbo].[usp_find_entity_id] TO [next_usr]
GO
GRANT EXECUTE ON  [dbo].[usp_find_entity_id] TO [public]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'usp_find_entity_id', NULL, NULL
GO
