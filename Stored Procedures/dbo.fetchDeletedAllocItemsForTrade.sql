...
CREATE procedure [dbo].[fetchDeletedAllocItemsForTrade] 
(       
   @trade_num        int,
   @trade_num1       int,
   @trade_num2       int
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'fetchDeletedAllocItemsForTrade', NULL, NULL
GO
