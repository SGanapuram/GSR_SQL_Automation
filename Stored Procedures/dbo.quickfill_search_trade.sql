...
declare @tradeType char(8),
   ...
   (
      ...
      order_on_exch_trans_id int         null
   )
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'quickfill_search_trade', NULL, NULL
GO
