...
set nocount on      
 ...
 fx_custom_column4,    
  ...
  into #fxexpdist1      
   from #fxexpdist      
  group by oid,fx_owner_code,fx_exp_num,fx_owner_key1,fx_owner_key2,fx_owner_key3,fx_owner_key4,fx_owner_key5,fx_owner_key6,    
    trade_num,order_num,item_num,fx_qty,fx_price,fx_amt,fx_qty_uom_code,fx_price_curr_code,fx_price_uom_code,fx_drop_date,    
    fx_priced_amt,fx_real_port_num,fx_custom_column1,fx_custom_column2,fx_custom_column3,fx_custom_column4    
  having count(*) = 1      
...
select       
 ...
 fx_custom_column4,    
     trans_id1      
   from #fxexpdist1 fx left outer join #diffColList difc    
 on fx.oid = difc.oid      
   where fx.resp_trans_id = @resp_trans_id_NEW      
   union            
  select       
     'OLD' as PASS,      
     b.resp_trans_id,  
