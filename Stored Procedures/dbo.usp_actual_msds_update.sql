...
CREATE proc [dbo].[usp_actual_msds_update]  
(          
...
AS            
BEGIN                    
 DECLARE @cntr int, @entity_tag_key int, @trans_id bigint  ,@cas_num varchar(100)  ,@msds_method varchar(15)  , @char_date_of_msds varchar(25)      
...
END       
GO
GRANT EXECUTE ON  [dbo].[usp_actual_msds_update] TO [next_usr]
GO
