...
CREATE procedure [dbo].[fetchSubAllocItemToAllocItem]
(
   @alloc_num          int,
   @asof_trans_id      int,
   @sub_alloc_num      smallint
)
as
set nocount on
   ...
   where alloc_num = @alloc_num and
         sub_alloc_num = @sub_alloc_num and
...
return
GO
GRANT EXECUTE ON  [dbo].[fetchSubAllocItemToAllocItem] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'fetchSubAllocItemToAllocItem', NULL, NULL
GO
