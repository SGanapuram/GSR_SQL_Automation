...
CREATE procedure [DBMAINT].[usp_archive_als_run]
(
   @daysold                int = 30,
   ...
   begin 
      ...
      insert into dbo.als_run_touch_archive
               (als_module_group_id, operation, entity_name,
                ...
                trans_id, sequence, touch_key, archived_date, executor_id)
...
GO
GRANT EXECUTE ON  [DBMAINT].[usp_archive_als_run] TO [next_usr]
GO
