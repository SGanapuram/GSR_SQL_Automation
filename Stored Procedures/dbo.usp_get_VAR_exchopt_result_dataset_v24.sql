...
CREATE procedure [dbo].[usp_get_VAR_exchopt_result_dataset_v24]     
   @run_date               datetime,    
...
declare @sql                    varchar(max),    
  ...
  */                   
   ...
   set @sql = @sql + 'from (select trditm.* from dbo.v_VAR_exchange_options_v24 trditm '    
...
return @status    
GO
GRANT EXECUTE ON  [dbo].[usp_get_VAR_exchopt_result_dataset_v24] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'usp_get_VAR_exchopt_result_dataset_v24', NULL, NULL
GO
