...
set nocount on            
  ...
  into #portpl1            
  from #portpl                       
  group by port_num, pl_asof_date,pl_curr_code, open_phys_pl, open_hedge_pl, closed_phys_pl,             
              closed_hedge_pl, other_pl,liq_open_phys_pl,liq_open_hedge_pl,liq_closed_phys_pl,            
              liq_closed_hedge_pl, is_week_end_ind, is_month_end_ind, is_year_end_ind,             
...
-- write changed columns    
 ...
 into #diffColList    
  ...
  select             
     ...
     pl1.port_num,             
     pl1.port_type,            
     convert(varchar, pl1.pl_asof_date, 101) as pl_asof_date,             
      open_phys_pl,            
open_hedge_pl,            
      closed_phys_pl,            
      closed_hedge_pl,            
     ...
     liq_closed_phys_pl,            
      ...
      is_official_run_ind,            
     trans_id1            
   from #portpl1 pl1  left outer join #diffColList difc        
 on pl1.port_num = difc.port_num and pl1.pl_asof_date= difc.pl_asof_date         
   where pl1.resp_trans_id = @resp_trans_id_NEW            
   union                  
  select             
     'OLD' as PASS,            
     b.resp_trans_id,    
 ...
 on b.port_num = difc.port_num and b.pl_asof_date= difc.pl_asof_date     
  where a.pl_asof_date = b.pl_asof_date and             
        a.port_num = b.port_num            
  order by port_num, pl_asof_date, resp_trans_id            
