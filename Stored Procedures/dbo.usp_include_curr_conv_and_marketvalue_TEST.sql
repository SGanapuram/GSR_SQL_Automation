...
CREATE procedure [dbo].[usp_include_curr_conv_and_marketvalue_TEST]        
...
when (isnull(c.cost_unit_price,0) != 0)-- and c.cost_type_code  in ('WPP', 'DPP', 'RINPP', 'BPP' , 'RPP' , 'OPP' , 'OTC' , 'PDO' , 'POC' , 'TPP' , 'SPP' , 'SWAP' , 'SWPR' , 'BO' , 'NO' , 'BOAI' , 'CPP' , 'CPR'))    
...
when (c.cost_price_uom_code is not null)-- and c.cost_type_code  in ('WPP', 'DPP', 'RINPP', 'BPP' , 'RPP' , 'OPP' , 'OTC' , 'PDO' , 'POC' , 'TPP' , 'SPP' , 'SWAP' , 'SWPR' , 'BO' , 'NO' , 'BOAI' , 'CPP' , 'CPR'))  
...
(case when ti2.item_type in('S','T') and a.alloc_type_code != 'J' then inv.inv_cost_curr_code            
      when (c.cost_price_curr_code is not null)-- and c.cost_type_code  in ('WPP', 'DPP', 'RINPP', 'BPP' , 'RPP' , 'OPP' , 'OTC' , 'PDO' , 'POC' , 'TPP' , 'SPP' , 'SWAP' , 'SWPR' , 'BO' , 'NO' , 'BOAI' , 'CPP' , 'CPR'))    
...
(case when ti2.item_type in('S','T') and a.alloc_type_code != 'J' then aie.ai_est_actual_date        
      when (c.cost_eff_date is not null)-- and c.cost_type_code  in ('WPP', 'DPP', 'RINPP', 'BPP' , 'RPP' , 'OPP' , 'OTC' , 'PDO' , 'POC' , 'TPP' , 'SPP' , 'SWAP' , 'SWPR' , 'BO' , 'NO' , 'BOAI' , 'CPP' , 'CPR'))   
...
GO
GRANT EXECUTE ON  [dbo].[usp_include_curr_conv_and_marketvalue_TEST] TO [next_usr]
GO
