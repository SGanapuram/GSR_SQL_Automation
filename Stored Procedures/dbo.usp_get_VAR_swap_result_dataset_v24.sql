...
CREATE procedure [dbo].[usp_get_VAR_swap_result_dataset_v24]     
   @run_date               datetime,    
...
declare @sql                    varchar(max),    
   ...
   */    
   ...
   set @sql = @sql + 'from dbo.v_VAR_swap_trades_v24 trditm '    
...
return @status    
GO
GRANT EXECUTE ON  [dbo].[usp_get_VAR_swap_result_dataset_v24] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'usp_get_VAR_swap_result_dataset_v24', NULL, NULL
GO
