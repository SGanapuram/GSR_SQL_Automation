...
declare @tradeType char(8),
   ...
   (
      ...
      trans_id_trade      int null,
      order_trans_id      int null
   )
   ...
   (
      ...
      trans_id_trade int null,
      order_trans_id int null,
      item_trans_id int null,
      fut_trans_id int null,
      opt_trans_id int null,
      phy_trans_id int null,
      trd_prd_desc varchar(8) null,
      cmnt_num int null,
      tiny_cmnt varchar(15) null,
      from_del_date varchar(2) null,
      to_del_date varchar(2) null,
      sync_trans_id int null
   )
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'inhouse_search_trade', NULL, NULL
GO
