...
set nocount on  
   ...
   select   
      ...
      avg_price  
        into #tidmtm1  
   from #tidmtm  
   group by dist_num, mtm_pl_asof_date, open_pl, 
            closed_pl,addl_cost_sum, delta,   
            vega, volatility, theta, curr_conv_rate, curr_code_conv_from,   
            curr_code_conv_to, interest_rate, price_diff_value, 
            dist_qty,alloc_qty, trade_value, market_value, curr_code, 
            qty_uom_code, gamma, discount_factor, rho, drift, 
            trade_modified_ind, commkt_key, pos_num,   
            trade_num, order_num, item_num, qty_uom_code_conv_to, 
            sec_qty_uom_code, sec_conversion_factor, trading_prd, 
            last_trade_date, dist_type, p_s_ind, opt_model_type, 
            leg_total_days, opt_priced_days, opt_priced_price,  
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'usp_compare_tid_mtm', NULL, NULL
GO
