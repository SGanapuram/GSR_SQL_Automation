...
errexit:
  return 1
GO
GRANT EXECUTE ON  [dbo].[usp_purge_icts_audit_data] TO [ictspurge]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'usp_purge_icts_audit_data', NULL, NULL
GO
