...
CREATE procedure [dbo].[fetchParcelToAllocationItem]
(
...
return
GO
GRANT EXECUTE ON  [dbo].[fetchParcelToAllocationItem] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'fetchParcelToAllocationItem', NULL, NULL
GO
