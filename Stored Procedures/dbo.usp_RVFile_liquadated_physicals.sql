...
CREATE procedure [dbo].[usp_RVFile_liquadated_physicals]
(
   @prior_pl_asof_date   datetime = null,
...
declare @rows_affected           int,
   ...
   where plh.pl_asof_date = @my_prior_pl_asof_date AND 
         exists (select 1
         ...
         NOT EXISTS (select 1 
                     ...
                     where plh.pl_owner_code = plh1.pl_owner_code AND
                           plh.pl_record_key = plh1.pl_record_key AND
                           plh.pl_type = plh1.pl_type AND 
   ...
   begin
      print ' '
      select @smsg = 'usp_RVFile_liquadated_physicals: ' + convert(varchar, @rows_affected) + ' rows returned.'
      print @smsg
      print ' '
...
return 0
GO
GRANT EXECUTE ON  [dbo].[usp_RVFile_liquadated_physicals] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'usp_RVFile_liquadated_physicals', NULL, NULL
GO
