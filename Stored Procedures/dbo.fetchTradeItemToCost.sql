...
CREATE procedure [dbo].[fetchTradeItemToCost]
(
   @asof_trans_id        int,
   @cost_owner_key6      int,
   @cost_owner_key7      int,
...
set nocount on
   ...
   select acct_num,
          ...
          vc_acct_num
   from dbo.cost
   where cost_owner_key6 = @cost_owner_key6 and
         cost_owner_key7 = @cost_owner_key7 and
         cost_owner_key8 = @cost_owner_key8 and
...
return
GO
GRANT EXECUTE ON  [dbo].[fetchTradeItemToCost] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'fetchTradeItemToCost', NULL, NULL
GO
