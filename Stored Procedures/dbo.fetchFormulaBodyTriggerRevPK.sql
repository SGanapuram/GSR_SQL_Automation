...
CREATE proc [dbo].[fetchFormulaBodyTriggerRevPK]
(
   @asof_trans_id       int,
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'fetchFormulaBodyTriggerRevPK', NULL, NULL
GO
