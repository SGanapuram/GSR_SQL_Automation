...
CREATE procedure [dbo].[fetchTradeOrderToTradeItem]
(
   @asof_trans_id   int,
   @order_num       smallint,
   @trade_num       int
...
return
GO
GRANT EXECUTE ON  [dbo].[fetchTradeOrderToTradeItem] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'fetchTradeOrderToTradeItem', NULL, NULL
GO
