...
set nocount on      
 ...
 custom_column4,    
  ...
  into #fxexp1      
   from #fxexp      
  group by oid,fx_exp_curr_oid,fx_trading_prd,fx_exposure_type,real_port_num,open_rate_amt,fixed_rate_amt,    
    linked_rate_amt,fx_exp_sub_type,status,custom_column1,custom_column2,custom_column3,custom_column4    
  having count(*) = 1      
 ...
 custom_column4,    
     trans_id1      
   from #fxexp1 fx left outer join #diffColList difc    
	on fx.oid = difc.oid    
