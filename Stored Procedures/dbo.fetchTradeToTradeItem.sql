...
CREATE procedure [dbo].[fetchTradeToTradeItem]
(
   @asof_trans_id  int,
   @trade_num      int
)
...
return
GO
GRANT EXECUTE ON  [dbo].[fetchTradeToTradeItem] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'fetchTradeToTradeItem', NULL, NULL
GO
