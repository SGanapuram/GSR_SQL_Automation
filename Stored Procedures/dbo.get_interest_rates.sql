...
CREATE procedure [dbo].[get_interest_rates]
(
...
return
GO
GRANT EXECUTE ON  [dbo].[get_interest_rates] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'get_interest_rates', NULL, NULL
GO
