...
CREATE procedure [dbo].[fetchAllocItemToCost]
(
...
return
GO
GRANT EXECUTE ON  [dbo].[fetchAllocItemToCost] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'fetchAllocItemToCost', NULL, NULL
GO
