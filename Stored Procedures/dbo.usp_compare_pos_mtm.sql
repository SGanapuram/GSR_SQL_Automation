...
set nocount on  
   ...
   select   
      ...
      resp_trans_id,   
      pos_num,  
      convert(varchar, mtm_asof_date, 101) as mtm_asof_date,  
      mtm_mkt_price,  
      volatility,  
      interest_rate,  
      delta,  
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'usp_compare_pos_mtm', NULL, NULL
GO
