...
CREATE procedure [dbo].[pl_records_toi] 
(  
   @top_portfolio         int,  
   @asofdate              datetime,  
...
GO
GRANT EXECUTE ON  [dbo].[pl_records_toi] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'pl_records_toi', NULL, NULL
GO
