...
declare @next_port_num     int,
   ...
   (    
      ...
      last_trans_id     int null,    
      nthprev_asof_date datetime null,    
      nthprev_trans_id  int null
   )    
   ...
   -- Internal fields    
      curr_pl_trans_id         int null,    
      prev_pl_trans_id         int null    
   )    
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'usp_changed_alloc_items', NULL, NULL
GO
