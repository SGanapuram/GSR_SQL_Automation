...
CREATE procedure [dbo].[fetchTradeItemToAllocItem]
(
   @asof_trans_id      int,
   @item_num           smallint,
   @order_num          smallint,
...
return
GO
GRANT EXECUTE ON  [dbo].[fetchTradeItemToAllocItem] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'fetchTradeItemToAllocItem', NULL, NULL
GO
