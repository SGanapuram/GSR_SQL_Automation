...
--  finish write changed columns.     
  select     
	 ...
	 diffColList,     
     tid.dist_num,     
     convert(varchar, tid.mtm_pl_asof_date, 101) as mtm_pl_asof_date,     
      tid.vol_num,    
      strike_price,    
      skew_price,    
      volatility,    
      ...
      use_option_skew,    
     trans_id1    
   from #tidmtmvol1 tid left outer join #diffColList difc    
 on tid.dist_num = difc.dist_num and tid.mtm_pl_asof_date= difc.mtm_pl_asof_date and tid.vol_num=difc.vol_num  
   where tid.resp_trans_id = @resp_trans_id_NEW    
   union          
  select     
     'OLD' as PASS,    
     b.resp_trans_id, 
 ...
 on b.dist_num = difc.dist_num and b.mtm_pl_asof_date= difc.mtm_pl_asof_date and b.vol_num=difc.vol_num
  where a.dist_num = b.dist_num and    
        a.mtm_pl_asof_date = b.mtm_pl_asof_date and    
        a.vol_num = b.vol_num    
  order by dist_num, mtm_pl_asof_date, resp_trans_id    
