...
set nocount on  
   ...
   where entity_tag_id in (select oid 
                           ...
                           where entity_id = (select oid 
											  ...
											  where entity_name = 'AllocationItem')) and 
   ...
   where entity_tag_id in (select entity_tag_id 
                           from entity_tag_definition 
                           where entity_id = (select oid 
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'fetchAllocItemToEntityTag', NULL, NULL
GO
