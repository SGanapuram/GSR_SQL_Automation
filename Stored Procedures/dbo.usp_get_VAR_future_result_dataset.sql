...
CREATE procedure [dbo].[usp_get_VAR_future_result_dataset] 
(
   @run_date               datetime,
...
declare @sql                    varchar(max),
  ...
  */               
   ...
   set @sql = @sql + 'from (select trditm.* from dbo.v_VAR_future_trades trditm '
...
return @status
GO
GRANT EXECUTE ON  [dbo].[usp_get_VAR_future_result_dataset] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'usp_get_VAR_future_result_dataset', NULL, NULL
GO
