...
CREATE procedure [dbo].[fetchParcelToTradeItem]
(
   @asof_trans_id      int,
   @item_num           smallint,
   @order_num          smallint,
...
return
GO
GRANT EXECUTE ON  [dbo].[fetchParcelToTradeItem] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'PROCEDURE', N'fetchParcelToTradeItem', NULL, NULL
GO
