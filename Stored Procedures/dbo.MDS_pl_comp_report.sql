...
CREATE PROC [dbo].[MDS_pl_comp_report]                              
@root_port_num    int,                                                  
...
declare @asofdate datetime                                                  
 ...
 where exists (select 1                               
    from [v_MDS_portfolio_profit_loss] ppl1 ,[v_MDS_portfolio_profit_loss] ppl2                              
...
END                     
GO
GRANT EXECUTE ON  [dbo].[MDS_pl_comp_report] TO [next_usr]
GO
