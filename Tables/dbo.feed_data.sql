...
[number_of_rows] [int] NOT NULL CONSTRAINT [DF__feed_data__numbe__72E607DB] DEFAULT ((0)),
[feed_id] [int] NOT NULL,
[status] [varchar] (20) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__feed_data__statu__73DA2C14] DEFAULT ('PENDING'),
...
begin
   raiserror ('(feed_data) The change needs to be attached with a new trans_id.',10,1)
   if @@trancount > 0 rollback tran
...
begin
   ...
   begin
      raiserror ('(feed_data) primary key can not be changed.',10,1)
      if @@trancount > 0 rollback tran
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'feed_data', NULL, NULL
GO
