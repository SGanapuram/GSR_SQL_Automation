...
[port_path] [varchar] (255) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__riskmgr_w__port___6DD739FB] DEFAULT (''),
[selected_index] [int] NOT NULL CONSTRAINT [DF__riskmgr_w__selec__6ECB5E34] DEFAULT ((0)),
[trans_id] [int] NOT NULL,
[show_history_pnl] [bit] NOT NULL CONSTRAINT [DF__riskmgr_w__show___6FBF826D] DEFAULT ((0)),
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'riskmgr_win_def', NULL, NULL
GO
