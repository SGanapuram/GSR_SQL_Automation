...
[acct_status] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__rg_stagin__acct___6B2FD77A] DEFAULT ('A'),
[acct_parent_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__rg_stagin__acct___6D181FEC] DEFAULT ('N'),
[acct_sub_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__rg_stagin__acct___6F00685E] DEFAULT ('N'),
...
[allows_netout] [bit] NOT NULL CONSTRAINT [DF__rg_stagin__allow__70E8B0D0] DEFAULT ((0)),
[allows_bookout] [bit] NOT NULL CONSTRAINT [DF__rg_stagin__allow__71DCD509] DEFAULT ((0)),
...
--begin
--   raiserror ('(rg_staging_acct) The change needs to be attached with a new trans_id.',10,1)
...
begin
   ...
   begin
      raiserror ('(rg_staging_acct) primary key can not be changed.',10,1)
      if @@trancount > 0 rollback tran
...
return
GO
ALTER TABLE [dbo].[rg_staging_acct] ADD CONSTRAINT [CK__rg_stagin__acct___6E0C4425] CHECK (([acct_parent_ind]='N' OR [acct_parent_ind]='Y'))
GO
ALTER TABLE [dbo].[rg_staging_acct] ADD CONSTRAINT [CK__rg_stagin__acct___6C23FBB3] CHECK (([acct_status]='I' OR [acct_status]='A'))
GO
ALTER TABLE [dbo].[rg_staging_acct] ADD CONSTRAINT [CK__rg_stagin__acct___6FF48C97] CHECK (([acct_sub_ind]='N' OR [acct_sub_ind]='Y'))
GO
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'rg_staging_acct', NULL, NULL
GO
