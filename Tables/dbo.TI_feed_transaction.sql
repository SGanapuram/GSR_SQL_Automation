...
[dd_status] [varchar] (20) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [df_TI_feed_transaction_dd_status] DEFAULT ('PENDING'),
[dd_instance_num] [int] NULL
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[TI_feed_transaction] ADD CONSTRAINT [chk_TI_feed_transaction_dd_status] CHECK (([dd_status]='INCOMPLETED' OR [dd_status]='FAILED' OR [dd_status]='COMPLETED' OR [dd_status]='PROCESSING' OR [dd_status]='PENDING'))
GO
