...
GO
GRANT DELETE ON  [dbo].[POSGRID_pl_history_yearend] TO [next_usr]
GO
GRANT INSERT ON  [dbo].[POSGRID_pl_history_yearend] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[POSGRID_pl_history_yearend] TO [next_usr]
GO
GRANT UPDATE ON  [dbo].[POSGRID_pl_history_yearend] TO [next_usr]
GO
