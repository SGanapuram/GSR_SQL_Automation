...
[p_or_r_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [df_rg_staging_acct_bank_info_p_or_r_ind] DEFAULT ('P'),
...
[acct_bank_info_status] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [df_rg_staging_acct_bank_info_acct_bank_info_status] DEFAULT ('A'),
...
--begin
--   raiserror ('(rg_staging_acct_bank_info) The change needs to be attached with a new trans_id.',16,1)
...
begin
   ...
   begin
      raiserror ('(rg_staging_acct_bank_info) primary key can not be changed.',16,1)
      if @@trancount > 0 rollback tran
...
return
GO
ALTER TABLE [dbo].[rg_staging_acct_bank_info] ADD CONSTRAINT [chk_rg_staging_acct_bank_info_acct_bank_info_status] CHECK (([acct_bank_info_status]='I' OR [acct_bank_info_status]='A'))
GO
ALTER TABLE [dbo].[rg_staging_acct_bank_info] ADD CONSTRAINT [chk_rg_staging_acct_bank_info_p_or_r_ind] CHECK (([p_or_r_ind]='R' OR [p_or_r_ind]='P'))
GO
