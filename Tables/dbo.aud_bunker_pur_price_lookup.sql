...
GO
GRANT DELETE ON  [dbo].[aud_bunker_pur_price_lookup] TO [ictspurge]
GO
GRANT SELECT ON  [dbo].[aud_bunker_pur_price_lookup] TO [ictspurge]
GO
GRANT UPDATE ON  [dbo].[aud_bunker_pur_price_lookup] TO [ictspurge]
GO
GRANT INSERT ON  [dbo].[aud_bunker_pur_price_lookup] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[aud_bunker_pur_price_lookup] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'aud_bunker_pur_price_lookup', NULL, NULL
GO
