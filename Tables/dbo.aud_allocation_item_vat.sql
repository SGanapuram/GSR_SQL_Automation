CREATE TABLE [dbo].[aud_allocation_item_vat]
(
...
GO
CREATE NONCLUSTERED INDEX [aud_allocation_item_vat] ON [dbo].[aud_allocation_item_vat] ([alloc_num], [alloc_item_num], [trans_id], [resp_trans_id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [aud_allocation_item_vat_idx1] ON [dbo].[aud_allocation_item_vat] ([trans_id]) ON [PRIMARY]
GO
GRANT DELETE ON  [dbo].[aud_allocation_item_vat] TO [ictspurge]
GO
GRANT SELECT ON  [dbo].[aud_allocation_item_vat] TO [ictspurge]
GO
GRANT UPDATE ON  [dbo].[aud_allocation_item_vat] TO [ictspurge]
GO
GRANT INSERT ON  [dbo].[aud_allocation_item_vat] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[aud_allocation_item_vat] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'aud_allocation_item_vat', NULL, NULL
GO
