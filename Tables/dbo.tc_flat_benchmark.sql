...
create trigger [dbo].[tc_flat_benchmark_deltrg]                                                                                                                       
on [dbo].[tc_flat_benchmark]                                                                                                                                          
for delete                                                                                                                                                
as                                                                                                                                                        
...
begin                                                                                                                                                     
   set @errmsg = '(tc_flat_benchmark) Failed to obtain a valid responsible trans_id.'                                                                        
   if exists (select 1                                                                                                                                    
              from master.dbo.sysprocesses (nolock)                                                                                                       
              where spid = @@spid and                                                                                                                     
...
insert dbo.aud_tc_flat_benchmark                                                                                                                                  
   (
	oid,
	cp_formula_oid,
	price_rule_oid,
...
declare @the_sequence       numeric(32, 0),                                                                                                               
   ...
   set @the_entity_name = 'TcFlatBenchmark'                                                                                                           
...
create trigger [dbo].[tc_flat_benchmark_instrg]                                                                   
on [dbo].[tc_flat_benchmark]                                                                                      
for insert                                                                                               
as                                                                                                       
declare @num_rows       int,                                                                             
...
create trigger [dbo].[tc_flat_benchmark_updtrg]                                                                                       
on [dbo].[tc_flat_benchmark]                                                                                                          
for update                                                                                                                   
as                                                                                                                           
declare @num_rows         int,                                                                                               
...
begin                                                                                                                        
   raiserror ('(tc_flat_benchmark) The change needs to be attached with a new trans_id',16,1)                                   
   rollback tran                                                                                                             
   return                                                                                                                    
end                                                                                                                          
...
begin                                                                                                                        
   ...
   begin                                                                                                                     
      set @errmsg = '(tc_flat_benchmark) New trans_id must be larger than original trans_id.'                                
...
if exists (select * from inserted i, deleted d                                                                               
           where i.trans_id < d.trans_id and                                                                                 
                 i.oid = d.oid)                                                                                             
begin                                                                                                                        
   raiserror ('(tc_flat_benchmark) new trans_id must not be older than current trans_id.',16,1)                                 
   rollback tran                                                                                                             
   return                                                                                                                    
end                                                                                                                          
...
begin                                                                                                                        
   ...
   begin                                                                                                                     
      raiserror ('(tc_flat_benchmark) primary key can not be changed.',16,1)                                                    
      rollback tran                                                                                                          
      return                                                                                                                 
   end                                                                                                                       
end                                                                                                                          
