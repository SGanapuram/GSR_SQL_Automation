...
[lc_exp_imp_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [df_lc_bankfee_autogen_lc_exp_imp_ind] DEFAULT ('E'),
[book_comp_num] [int] NOT NULL,
[issuing_bank] [int] NOT NULL,
[lc_bankfee_amt_type] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [df_lc_bankfee_autogen_lc_bankfee_amt_type] DEFAULT ('F'),
[lc_bankfee_amt] [decimal] (20, 8) NOT NULL,
[lc_bankfee_curr_code] [char] (8) COLLATE SQL_Latin1_General_CP1_CS_AS NULL,
[lc_bankfee_status] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [df_lc_bankfee_autogen_lc_bankfee_status] DEFAULT ('A'),
[trans_id] [int] NOT NULL,
[fee_validity_date] [datetime] NULL CONSTRAINT [df_lc_bankfee_autogen_fee_validity_date] DEFAULT ('01/01/2001')
) ON [PRIMARY]
GO
...
begin
   ...
   begin
      raiserror ('(lc_bankfee_autogen) primary key can not be changed.',16,1)
      if @@trancount > 0 rollback tran
...
return
GO
ALTER TABLE [dbo].[lc_bankfee_autogen] ADD CONSTRAINT [chk_lc_bankfee_autogen_lc_bankfee_amt_type] CHECK (([lc_bankfee_amt_type]='P' OR [lc_bankfee_amt_type]='F'))
GO
ALTER TABLE [dbo].[lc_bankfee_autogen] ADD CONSTRAINT [chk_lc_bankfee_autogen_lc_bankfee_status] CHECK (([lc_bankfee_status]='I' OR [lc_bankfee_status]='A'))
GO
ALTER TABLE [dbo].[lc_bankfee_autogen] ADD CONSTRAINT [chk_lc_bankfee_autogen_lc_exp_imp_ind] CHECK (([lc_exp_imp_ind]='I' OR [lc_exp_imp_ind]='E'))
GO
