...
[operation] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [df_feed_transaction_operation] DEFAULT ('I')
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[feed_transaction] ADD CONSTRAINT [chk_feed_transaction_operation] CHECK (([operation]='D' OR [operation]='U' OR [operation]='I'))
GO
