CREATE TABLE [dbo].[trade_item_conc]
(
...
create trigger [dbo].[trade_item_conc_deltrg]
on [dbo].[trade_item_conc]
for delete
as
...
begin
   select @errmsg = '(trade_item_conc) Failed to obtain a valid responsible trans_id.'
   if exists (select 1
              from master.dbo.sysprocesses (nolock)
              where spid = @@spid and
...
insert dbo.aud_trade_item_conc
   (trade_num,
    order_num,
    item_num,
    min_qty,
...
declare @the_sequence       numeric(32, 0),
   ...
   select @the_entity_name = 'TradeItemConc'
...
create trigger [dbo].[trade_item_conc_instrg]
on [dbo].[trade_item_conc]
for insert
as
declare @num_rows        int,
...
create trigger [dbo].[trade_item_conc_updtrg]
on [dbo].[trade_item_conc]
for update
as
declare @num_rows         int,
...
begin
   raiserror ('(trade_item_conc) The change needs to be attached with a new trans_id',10,1)
   if @@trancount > 0 rollback tran
...
begin
   ...
   begin
      select @errmsg = '(trade_item_conc) New trans_id must be larger than original trans_id.'
...
begin
   raiserror ('(trade_item_conc) new trans_id must not be older than current trans_id.',10,1)
   if @@trancount > 0 rollback tran
...
begin
   ...
   begin
      raiserror ('(trade_item_conc) primary key can not be changed.',10,1)
      if @@trancount > 0 rollback tran
...
return
GO
ALTER TABLE [dbo].[trade_item_conc] ADD CONSTRAINT [trade_item_conc_pk] PRIMARY KEY CLUSTERED  ([trade_num], [order_num], [item_num]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[trade_item_conc] ADD CONSTRAINT [trade_item_conc_fk1] FOREIGN KEY ([credit_term_code]) REFERENCES [dbo].[credit_term] ([credit_term_code])
GO
ALTER TABLE [dbo].[trade_item_conc] ADD CONSTRAINT [trade_item_conc_fk10] FOREIGN KEY ([max_qty_uom_code]) REFERENCES [dbo].[uom] ([uom_code])
GO
ALTER TABLE [dbo].[trade_item_conc] ADD CONSTRAINT [trade_item_conc_fk11] FOREIGN KEY ([tol_qty_uom_code]) REFERENCES [dbo].[uom] ([uom_code])
GO
ALTER TABLE [dbo].[trade_item_conc] ADD CONSTRAINT [trade_item_conc_fk12] FOREIGN KEY ([min_ship_qty_uom_code]) REFERENCES [dbo].[uom] ([uom_code])
GO
ALTER TABLE [dbo].[trade_item_conc] ADD CONSTRAINT [trade_item_conc_fk15] FOREIGN KEY ([prelim_pay_term_code]) REFERENCES [dbo].[payment_term] ([pay_term_code])
GO
ALTER TABLE [dbo].[trade_item_conc] ADD CONSTRAINT [trade_item_conc_fk18] FOREIGN KEY ([tank_num]) REFERENCES [dbo].[location_tank_info] ([tank_num])
GO
ALTER TABLE [dbo].[trade_item_conc] ADD CONSTRAINT [trade_item_conc_fk19] FOREIGN KEY ([facility_code]) REFERENCES [dbo].[facility] ([facility_code])
GO
ALTER TABLE [dbo].[trade_item_conc] ADD CONSTRAINT [trade_item_conc_fk2] FOREIGN KEY ([del_term_code]) REFERENCES [dbo].[delivery_term] ([del_term_code])
GO
ALTER TABLE [dbo].[trade_item_conc] ADD CONSTRAINT [trade_item_conc_fk20] FOREIGN KEY ([credit_approver_init]) REFERENCES [dbo].[icts_user] ([user_init])
GO
ALTER TABLE [dbo].[trade_item_conc] ADD CONSTRAINT [trade_item_conc_fk21] FOREIGN KEY ([umpire_rule_num]) REFERENCES [dbo].[umpire_rule] ([rule_num])
GO
ALTER TABLE [dbo].[trade_item_conc] ADD CONSTRAINT [trade_item_conc_fk3] FOREIGN KEY ([sch_init]) REFERENCES [dbo].[icts_user] ([user_init])
GO
ALTER TABLE [dbo].[trade_item_conc] ADD CONSTRAINT [trade_item_conc_fk4] FOREIGN KEY ([del_loc_code]) REFERENCES [dbo].[location] ([loc_code])
GO
ALTER TABLE [dbo].[trade_item_conc] ADD CONSTRAINT [trade_item_conc_fk5] FOREIGN KEY ([mot_code]) REFERENCES [dbo].[mot] ([mot_code])
GO
ALTER TABLE [dbo].[trade_item_conc] ADD CONSTRAINT [trade_item_conc_fk6] FOREIGN KEY ([pay_term_code]) REFERENCES [dbo].[payment_term] ([pay_term_code])
GO
ALTER TABLE [dbo].[trade_item_conc] ADD CONSTRAINT [trade_item_conc_fk9] FOREIGN KEY ([min_qty_uom_code]) REFERENCES [dbo].[uom] ([uom_code])
GO
GRANT DELETE ON  [dbo].[trade_item_conc] TO [next_usr]
GO
GRANT INSERT ON  [dbo].[trade_item_conc] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[trade_item_conc] TO [next_usr]
GO
GRANT UPDATE ON  [dbo].[trade_item_conc] TO [next_usr]
GO
