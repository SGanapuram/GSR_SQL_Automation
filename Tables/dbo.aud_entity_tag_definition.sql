...
GO
GRANT DELETE ON  [dbo].[aud_entity_tag_definition] TO [ictspurge]
GO
GRANT SELECT ON  [dbo].[aud_entity_tag_definition] TO [ictspurge]
GO
GRANT UPDATE ON  [dbo].[aud_entity_tag_definition] TO [ictspurge]
GO
GRANT INSERT ON  [dbo].[aud_entity_tag_definition] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[aud_entity_tag_definition] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'aud_entity_tag_definition', NULL, NULL
GO
