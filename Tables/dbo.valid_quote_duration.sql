...
begin
   raiserror('(valid_quote_duration) The change needs to be attached with a new trans_id.', 16, 1)
   rollback tran
   return
end
...
begin
   ...
   begin
      raiserror('(valid_quote_duration) primary key can not be changed.', 16, 1)
      rollback tran
      return
   end
end
