...
[horizon] [int] NULL,
[var_limit] [float] NOT NULL CONSTRAINT [df_var_limit_var_limit] DEFAULT ((0)),
...
[last_update_date] [datetime] NOT NULL CONSTRAINT [df_var_limit_last_update_date] DEFAULT (getdate())
) ON [PRIMARY]
GO
