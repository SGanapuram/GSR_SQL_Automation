...
[show_future_equiv] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [df_riskmgr_win_pivot_def_show_future_equiv] DEFAULT ('N'),
[pivot_layout] [varchar] (max) COLLATE SQL_Latin1_General_CP1_CS_AS NULL,
[show_zero] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [df_riskmgr_win_pivot_def_show_zero] DEFAULT ('N'),
[asof_date] [date] NULL,
[primary_uom] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [df_riskmgr_win_pivot_def_primary_uom] DEFAULT ('N'),
...
return
GO
ALTER TABLE [dbo].[riskmgr_win_pivot_def] ADD CONSTRAINT [chk_riskmgr_win_pivot_def_primary_uom] CHECK (([primary_uom]='n' OR [primary_uom]='N' OR [primary_uom]='y' OR [primary_uom]='Y'))
GO
ALTER TABLE [dbo].[riskmgr_win_pivot_def] ADD CONSTRAINT [chk_riskmgr_win_pivot_def_show_future_equiv] CHECK (([show_future_equiv]='n' OR [show_future_equiv]='N' OR [show_future_equiv]='y' OR [show_future_equiv]='Y'))
GO
