...
begin
   raiserror ('contract_status) The change needs to be attached with a new trans_id',16,1)
   rollback tran
   return
end
...
begin
   ...
   begin
      raiserror ('(contract_status) New trans_id must be larger than original trans_id.You can use the the gen_new_transaction procedure to obtain a new trans_id.',16,1)
...
begin
   raiserror ('(contract_status) new trans_id must not be older than current trans_id.',16,1)
   rollback tran
   return
end
...
begin
   ...
   begin
      raiserror ('contract_status: primary key can not be changed.',16,1)
      rollback tran
      return
   end
end
...
GO
GRANT DELETE ON  [dbo].[contract_status] TO [next_usr]
GO
GRANT INSERT ON  [dbo].[contract_status] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[contract_status] TO [next_usr]
GO
GRANT UPDATE ON  [dbo].[contract_status] TO [next_usr]
GO
