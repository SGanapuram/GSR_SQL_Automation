...
[manual_transport_parcels] [bit] NOT NULL CONSTRAINT [DF__aud_shipm__manua__28E2F130] DEFAULT ((1)),
...
GO
GRANT DELETE ON  [dbo].[aud_shipment] TO [ictspurge]
GO
GRANT SELECT ON  [dbo].[aud_shipment] TO [ictspurge]
GO
GRANT UPDATE ON  [dbo].[aud_shipment] TO [ictspurge]
GO
GRANT INSERT ON  [dbo].[aud_shipment] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[aud_shipment] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'aud_shipment', NULL, NULL
GO
