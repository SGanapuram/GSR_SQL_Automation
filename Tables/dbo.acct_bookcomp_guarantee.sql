...
[guarantee_type] [varchar] (15) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__acct_book__guara__49C3F6B7] DEFAULT ('PCG'),
[order_type_code] [char] (8) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__acct_book__order__4BAC3F29] DEFAULT ('PHYSICAL'),
[guarantee_amt] [numeric] (20, 8) NOT NULL,
[guarantee_curr_code] [char] (8) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL,
[guarantee_direction] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__acct_book__guara__4D94879B] DEFAULT ('I'),
...
begin
   raiserror ('(acct_bookcomp_guarantee) The change needs to be attached with a new trans_id.',10,1)
   if @@trancount > 0 rollback tran
...
begin
   ...
   begin
      raiserror ('(acct_bookcomp_guarantee) primary key can not be changed.',10,1)
      if @@trancount > 0 rollback tran
...
return
GO
ALTER TABLE [dbo].[acct_bookcomp_guarantee] ADD CONSTRAINT [CK__acct_book__guara__4E88ABD4] CHECK (([guarantee_direction]='O' OR [guarantee_direction]='I'))
GO
ALTER TABLE [dbo].[acct_bookcomp_guarantee] ADD CONSTRAINT [CK__acct_book__guara__4AB81AF0] CHECK (([guarantee_type]='COMFORTLETTER' OR [guarantee_type]='PCG'))
GO
ALTER TABLE [dbo].[acct_bookcomp_guarantee] ADD CONSTRAINT [CK__acct_book__order__4CA06362] CHECK (([order_type_code]='DERIVATI' OR [order_type_code]='PHYSICAL'))
GO
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'acct_bookcomp_guarantee', NULL, NULL
GO
