CREATE TABLE [dbo].[aud_ag_btt_nom_litem]
(
...
GO
CREATE NONCLUSTERED INDEX [aud_ag_btt_nom_litem] ON [dbo].[aud_ag_btt_nom_litem] ([fdd_oid], [trans_id], [resp_trans_id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [aud_ag_btt_nom_litem_idx1] ON [dbo].[aud_ag_btt_nom_litem] ([trans_id]) ON [PRIMARY]
GO
GRANT DELETE ON  [dbo].[aud_ag_btt_nom_litem] TO [ictspurge]
GO
GRANT SELECT ON  [dbo].[aud_ag_btt_nom_litem] TO [ictspurge]
GO
GRANT UPDATE ON  [dbo].[aud_ag_btt_nom_litem] TO [ictspurge]
GO
GRANT INSERT ON  [dbo].[aud_ag_btt_nom_litem] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[aud_ag_btt_nom_litem] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'aud_ag_btt_nom_litem', NULL, NULL
GO
