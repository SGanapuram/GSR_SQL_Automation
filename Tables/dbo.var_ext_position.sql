...
[what_if_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__var_ext_p__what___5748DA5E] DEFAULT ('N'),
[creation_date] [datetime] NOT NULL CONSTRAINT [DF__var_ext_p__creat__583CFE97] DEFAULT (getdate()),
...
return  
GO
ALTER TABLE [dbo].[var_ext_position] ADD CONSTRAINT [CK__var_ext_p__p_s_i__556091EC] CHECK (([p_s_ind]='P' OR [p_s_ind]='S'))
GO
ALTER TABLE [dbo].[var_ext_position] ADD CONSTRAINT [CK__var_ext_p__what___5654B625] CHECK (([what_if_ind]='Y' OR [what_if_ind]='N'))
GO
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'var_ext_position', NULL, NULL
GO
