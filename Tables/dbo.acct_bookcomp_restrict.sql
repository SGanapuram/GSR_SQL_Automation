...
[nobuy_restriction_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__acct_book__nobuy__5165187F] DEFAULT ('N'),
[nosell_restriction_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__acct_book__nosel__534D60F1] DEFAULT ('N'),
[order_type_group] [char] (8) COLLATE SQL_Latin1_General_CP1_CS_AS NULL,
[restriction_eff_date] [datetime] NOT NULL CONSTRAINT [DF__acct_book__restr__5535A963] DEFAULT (getdate()),
[restriction_end_date] [datetime] NOT NULL CONSTRAINT [DF__acct_book__restr__5629CD9C] DEFAULT ('12/31/2078'),
...
begin
   raiserror ('(acct_bookcomp_restrict) The change needs to be attached with a new trans_id.',10,1)
   if @@trancount > 0 rollback tran
...
begin
   ...
   begin
      raiserror ('(acct_bookcomp_restrict) primary key can not be changed.',10,1)
      if @@trancount > 0 rollback tran
...
return
GO
ALTER TABLE [dbo].[acct_bookcomp_restrict] ADD CONSTRAINT [CK__acct_book__nobuy__52593CB8] CHECK (([nobuy_restriction_ind]='N' OR [nobuy_restriction_ind]='Y'))
GO
ALTER TABLE [dbo].[acct_bookcomp_restrict] ADD CONSTRAINT [CK__acct_book__nosel__5441852A] CHECK (([nosell_restriction_ind]='N' OR [nosell_restriction_ind]='Y'))
GO
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'acct_bookcomp_restrict', NULL, NULL
GO
