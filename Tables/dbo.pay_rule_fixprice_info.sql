...
create trigger [dbo].[pay_rule_fixprice_info_deltrg]                                                                                                                       
on [dbo].[pay_rule_fixprice_info]                                                                                                                                          
for delete                                                                                                                                                
as                                                                                                                                                        
...
begin                                                                                                                                                     
   set @errmsg = '(pay_rule_fixprice_info) Failed to obtain a valid responsible trans_id.'                                                                        
   if exists (select 1                                                                                                                                    
              from master.dbo.sysprocesses (nolock)                                                                                                       
              where spid = @@spid and                                                                                                                     
...
insert dbo.aud_pay_rule_fixprice_info                                                                                                                                  
   (                                                                                                                                                      
	oid,
	cp_formula_oid,
	price_rule_oid,
...
declare @the_sequence       numeric(32, 0),                                                                                                               
   ...
   set @the_entity_name = 'PayRuleFixpriceInfo'                                                                                                           
...
create trigger [dbo].[pay_rule_fixprice_info_instrg]                                                                   
on [dbo].[pay_rule_fixprice_info]                                                                                      
for insert                                                                                               
as                                                                                                       
declare @num_rows       int,                                                                             
...
create trigger [dbo].[pay_rule_fixprice_info_updtrg]                                                                                       
on [dbo].[pay_rule_fixprice_info]                                                                                                          
for update                                                                                                                   
as                                                                                                                           
declare @num_rows         int,                                                                                               
...
begin                                                                                                                        
   raiserror('(pay_rule_fixprice_info) The change needs to be attached with a new trans_id',16,1)                                   
   rollback tran                                                                                                             
   return                                                                                                                    
end                                                                                                                          
...
begin                                                                                                                        
   ...
   begin                                                                                                                     
      set @errmsg = '(pay_rule_fixprice_info) New trans_id must be larger than original trans_id.'                                
...
if exists (select * from inserted i, deleted d                                                                               
           where i.trans_id < d.trans_id and                                                                                 
                 i.oid = d.oid)                                                                                             
begin                                                                                                                        
   raiserror ('(pay_rule_fixprice_info) new trans_id must not be older than current trans_id.',16,1)                                 
   rollback tran                                                                                                             
   return                                                                                                                    
end                                                                                                                          
...
begin                                                                                                                        
   ...
   begin                                                                                                                     
      raiserror ('(pay_rule_fixprice_info) primary key can not be changed.',16,1)                                                    
      rollback tran                                                                                                          
      return                                                                                                                 
   end                                                                                                                       
end                                                                                                                          
