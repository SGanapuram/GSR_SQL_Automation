...
GO
ALTER TABLE [dbo].[aud_ag_truck_actual_details] ADD CONSTRAINT [chk_aud_ag_truck_actual_details_rejected_load] CHECK (([rejected_load]=NULL OR [rejected_load]='N' OR [rejected_load]='Y'))
GO
