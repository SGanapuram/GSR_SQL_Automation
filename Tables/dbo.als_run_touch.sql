...
GO
CREATE NONCLUSTERED INDEX [als_run_touch_idx3] ON [dbo].[als_run_touch] ([als_module_group_id], [operation], [entity_name], [trans_id], [sequence]) INCLUDE ([key1], [key2], [key3], [key4], [key5], [key6], [key7], [key8], [touch_key]) ON [PRIMARY]
GO
