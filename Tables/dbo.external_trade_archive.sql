...
[archived_date] [datetime] NOT NULL CONSTRAINT [DF__external___archi__5555A4F4] DEFAULT (getdate())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'external_trade_archive', NULL, NULL
GO
