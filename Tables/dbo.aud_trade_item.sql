...
[includes_excise_tax_ind] [bit] NOT NULL CONSTRAINT [df_aud_trade_item_includes_excise_tax_ind] DEFAULT ((0)),
[includes_fuel_tax_ind] [bit] NOT NULL CONSTRAINT [df_aud_trade_item_includes_fuel_tax_ind] DEFAULT ((0)),
...
[is_lc_assigned] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [df_aud_trade_item_is_lc_assigned] DEFAULT ('N'),
[is_rc_assigned] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [df_aud_trade_item_is_rc_assigned] DEFAULT ('N'),
[b2b_trade_item] [varchar] (20) COLLATE SQL_Latin1_General_CP1_CS_AS NULL,
[use_mkt_formula_for_pl] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [df_aud_trade_item_use_mkt_formula_for_pl] DEFAULT ('Y'),
...
GO
CREATE NONCLUSTERED INDEX [aud_trade_item_idx5] ON [dbo].[aud_trade_item] ([real_port_num], [item_type], [trade_num], [order_num], [item_num]) WITH (DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [aud_trade_item_idx] ON [dbo].[aud_trade_item] ([trade_num], [order_num], [item_num], [trans_id], [resp_trans_id]) WITH (DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [aud_trade_item_idx3] ON [dbo].[aud_trade_item] ([trade_num], [order_num], [parent_item_num], [trans_id], [resp_trans_id]) WITH (DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
CREATE CLUSTERED INDEX [aud_trade_item] ON [dbo].[aud_trade_item] ([trading_prd], [risk_mkt_code], [cmdty_code], [item_num], [order_num], [trade_num]) WITH (DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [aud_trade_item_idx4] ON [dbo].[aud_trade_item] ([trans_id]) WITH (DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [aud_trade_item_idx2] ON [dbo].[aud_trade_item] ([trans_id], [trade_num], [order_num], [item_num]) WITH (DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
