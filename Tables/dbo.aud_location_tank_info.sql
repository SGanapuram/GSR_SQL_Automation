...
[location_tank_info_type] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__aud_locat__locat__3B36AB95] DEFAULT ('T'),
[confirmation_status] [bit] NOT NULL CONSTRAINT [DF__aud_locat__confi__3D1EF407] DEFAULT ((0)),
[first_purchaser_ind] [bit] NOT NULL CONSTRAINT [DF__aud_locat__first__3E131840] DEFAULT ((0)),
...
GO
ALTER TABLE [dbo].[aud_location_tank_info] ADD CONSTRAINT [CK__aud_locat__locat__3C2ACFCE] CHECK (([location_tank_info_type]='T' OR [location_tank_info_type]='L'))
GO
...
GO
GRANT DELETE ON  [dbo].[aud_location_tank_info] TO [ictspurge]
GO
GRANT SELECT ON  [dbo].[aud_location_tank_info] TO [ictspurge]
GO
GRANT UPDATE ON  [dbo].[aud_location_tank_info] TO [ictspurge]
GO
GRANT INSERT ON  [dbo].[aud_location_tank_info] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[aud_location_tank_info] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'aud_location_tank_info', NULL, NULL
GO
