...
[margin_type] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__aud_commk__margi__68736660] DEFAULT ('P')
) ON [PRIMARY]
GO
...
GO
GRANT DELETE ON  [dbo].[aud_commkt_clrd_swap_attr] TO [ictspurge]
GO
GRANT SELECT ON  [dbo].[aud_commkt_clrd_swap_attr] TO [ictspurge]
GO
GRANT UPDATE ON  [dbo].[aud_commkt_clrd_swap_attr] TO [ictspurge]
GO
GRANT INSERT ON  [dbo].[aud_commkt_clrd_swap_attr] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[aud_commkt_clrd_swap_attr] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'aud_commkt_clrd_swap_attr', NULL, NULL
GO
