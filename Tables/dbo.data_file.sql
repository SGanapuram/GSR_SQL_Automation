...
[type] [varchar] (40) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__data_file__type__1042F746] DEFAULT ('Market'),
[track_successes] [bit] NOT NULL CONSTRAINT [DF__data_file__track__477E1D97] DEFAULT ((0)),
[skip_unmapped_records] [bit] NULL CONSTRAINT [DF__data_file__skip___487241D0] DEFAULT ((0)),
[is_active] [bit] NOT NULL CONSTRAINT [DF__data_file__is_ac__5967C3A8] DEFAULT ((1))
) ON [PRIMARY]
GO
