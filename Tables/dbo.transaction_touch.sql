...
if @num_rows = 0
   ...
   begin
      raiserror ('The transaction_touch table has experienced the BIG IDENTITY GAP problem..Report this problem to your DBA now.',16,1)
...
GO
CREATE NONCLUSTERED INDEX [transaction_touch_idx3] ON [dbo].[transaction_touch] ([operation], [entity_name], [key1], [key2], [key3]) INCLUDE ([key4], [key5], [key6], [key7], [key8], [sequence], [touch_key], [touch_type], [trans_id]) ON [PRIMARY]
GO
