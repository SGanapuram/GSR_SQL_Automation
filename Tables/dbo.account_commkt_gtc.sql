...
[netting_forwards_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__account_c__netti__182C9B23] DEFAULT ('N'),
[netting_vouchers_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__account_c__netti__1A14E395] DEFAULT ('N'),
[creator_init] [char] (3) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL,
[creation_date] [datetime] NOT NULL CONSTRAINT [DF__account_c__creat__1BFD2C07] DEFAULT (getdate()),
...
begin
   raiserror ('(account_commkt_gtc) The change needs to be attached with a new trans_id',10,1)
   if @@trancount > 0 rollback tran
...
begin
   raiserror ('(account_commkt_gtc) new trans_id must not be older than current trans_id.',10,1)
   if @@trancount > 0 rollback tran
...
begin
   ...
   begin
      raiserror ('(account_commkt_gtc) primary key can not be changed.',10,1)
      if @@trancount > 0 rollback tran
...
return
GO
ALTER TABLE [dbo].[account_commkt_gtc] ADD CONSTRAINT [CK__account_c__netti__1920BF5C] CHECK (([netting_forwards_ind]='N' OR [netting_forwards_ind]='Y'))
GO
ALTER TABLE [dbo].[account_commkt_gtc] ADD CONSTRAINT [CK__account_c__netti__1B0907CE] CHECK (([netting_vouchers_ind]='N' OR [netting_vouchers_ind]='Y'))
GO
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'account_commkt_gtc', NULL, NULL
GO
