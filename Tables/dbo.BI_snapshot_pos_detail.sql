CREATE TABLE [dbo].[BI_snapshot_pos_detail]
(
...
GO
CREATE NONCLUSTERED INDEX [BI_snapshot_pos_detail_idx1] ON [dbo].[BI_snapshot_pos_detail] ([asof_date], [pos_num]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [BI_snapshot_pos_detail_idx2] ON [dbo].[BI_snapshot_pos_detail] ([trans_id]) ON [PRIMARY]
GO
GRANT DELETE ON  [dbo].[BI_snapshot_pos_detail] TO [next_usr]
GO
GRANT INSERT ON  [dbo].[BI_snapshot_pos_detail] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[BI_snapshot_pos_detail] TO [next_usr]
GO
GRANT UPDATE ON  [dbo].[BI_snapshot_pos_detail] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'BI_snapshot_pos_detail', NULL, NULL
GO
