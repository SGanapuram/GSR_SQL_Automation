CREATE TABLE [dbo].[rc_flat_benchmark]
(
[oid] [int] NOT NULL,
...
create trigger [dbo].[rc_flat_benchmark_deltrg]                                                                                                                       
on [dbo].[rc_flat_benchmark]                                                                                                                                          
for delete                                                                                                                                                
as                                                                                                                                                        
...
begin                                                                                                                                                     
   set @errmsg = '(rc_flat_benchmark) Failed to obtain a valid responsible trans_id.'                                                                        
   if exists (select 1                                                                                                                                    
              from master.dbo.sysprocesses (nolock)                                                                                                       
              where spid = @@spid and                                                                                                                     
...
insert dbo.aud_rc_flat_benchmark                                                                                                                                  
   (                                                                                                                                                      
	oid,
	cp_formula_oid,
	price_rule_oid,
...
select                                                                                                                                                    
	...
	d.flat_percentage,
	d.app_to_flat,
	d.benchmark_detail_oid,
	d.benchmark_value,
	d.benchmark_percentage,
	d.app_to_benchmark,
	d.rc_value,
	d.trans_id,
	@atrans_id,
...
declare @the_sequence       numeric(32, 0),                                                                                                               
   ...
   set @the_entity_name = 'RcFlatBenchmark'                                                                                                           
...
create trigger [dbo].[rc_flat_benchmark_instrg]                                                                   
on [dbo].[rc_flat_benchmark]                                                                                      
for insert                                                                                               
as                                                                                                       
declare @num_rows       int,                                                                             
...
create trigger [dbo].[rc_flat_benchmark_updtrg]                                                                                       
on [dbo].[rc_flat_benchmark]                                                                                                          
for update                                                                                                                   
as                                                                                                                           
declare @num_rows         int,                                                                                               
...
begin                                                                                                                        
   raiserror ('(rc_flat_benchmark) The change needs to be attached with a new trans_id',16,1)                                   
   rollback tran                                                                                                             
   return                                                                                                                    
end                                                                                                                          
...
begin                                                                                                                        
   ...
   begin                                                                                                                     
      set @errmsg = '(rc_flat_benchmark) New trans_id must be larger than original trans_id.'                                
...
if exists (select * from inserted i, deleted d                                                                               
           where i.trans_id < d.trans_id and                                                                                 
                 i.oid = d.oid )                                                                                             
begin                                                                                                                        
   raiserror ('(rc_flat_benchmark) new trans_id must not be older than current trans_id.',16,1)                                 
   rollback tran                                                                                                             
   return                                                                                                                    
end                                                                                                                          
...
begin                                                                                                                        
   ...
   begin                                                                                                                     
      raiserror ('(rc_flat_benchmark) primary key can not be changed.',10,1)                                                    
      rollback tran                                                                                                          
      return                                                                                                                 
   end                                                                                                                       
end                                                                                                                          
...
return                                                                                                                       
GO
ALTER TABLE [dbo].[rc_flat_benchmark] ADD CONSTRAINT [rc_flat_benchmark_pk] PRIMARY KEY CLUSTERED  ([oid]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[rc_flat_benchmark] ADD CONSTRAINT [rc_flat_benchmark_fk1] FOREIGN KEY ([cp_formula_oid]) REFERENCES [dbo].[contract_pricing_formula] ([oid])
GO
ALTER TABLE [dbo].[rc_flat_benchmark] ADD CONSTRAINT [rc_flat_benchmark_fk2] FOREIGN KEY ([price_rule_oid]) REFERENCES [dbo].[pricing_rule] ([oid])
GO
ALTER TABLE [dbo].[rc_flat_benchmark] ADD CONSTRAINT [rc_flat_benchmark_fk3] FOREIGN KEY ([benchmark_detail_oid]) REFERENCES [dbo].[benchmark_detail] ([oid])
GO
GRANT DELETE ON  [dbo].[rc_flat_benchmark] TO [next_usr]
GO
GRANT INSERT ON  [dbo].[rc_flat_benchmark] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[rc_flat_benchmark] TO [next_usr]
GO
GRANT UPDATE ON  [dbo].[rc_flat_benchmark] TO [next_usr]
GO
