...
[formula_comp_pos_num] [smallint] NOT NULL,
...
GO
GRANT DELETE ON  [dbo].[aud_formula_component] TO [ictspurge]
GO
GRANT SELECT ON  [dbo].[aud_formula_component] TO [ictspurge]
GO
GRANT UPDATE ON  [dbo].[aud_formula_component] TO [ictspurge]
GO
GRANT INSERT ON  [dbo].[aud_formula_component] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[aud_formula_component] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'aud_formula_component', NULL, NULL
GO
