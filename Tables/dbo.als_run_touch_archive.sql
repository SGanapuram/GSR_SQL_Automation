...
[archived_date] [datetime] NOT NULL CONSTRAINT [DF__als_run_t__archi__498EEC8D] DEFAULT (getdate())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'als_run_touch_archive', NULL, NULL
GO
