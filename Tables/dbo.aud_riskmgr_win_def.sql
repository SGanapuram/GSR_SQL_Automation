...
[show_history_pnl] [bit] NOT NULL CONSTRAINT [DF__aud_riskm__show___015F0FBB] DEFAULT ((0)),
...
GO
GRANT DELETE ON  [dbo].[aud_riskmgr_win_def] TO [ictspurge]
GO
GRANT SELECT ON  [dbo].[aud_riskmgr_win_def] TO [ictspurge]
GO
GRANT UPDATE ON  [dbo].[aud_riskmgr_win_def] TO [ictspurge]
GO
GRANT INSERT ON  [dbo].[aud_riskmgr_win_def] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[aud_riskmgr_win_def] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'aud_riskmgr_win_def', NULL, NULL
GO
