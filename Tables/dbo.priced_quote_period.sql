...
begin
   raiserror('(priced_quote_period) The change needs to be attached with a new trans_id.', 10, 1)
   rollback tran
   return
end
...
begin
   ...
   begin
      raiserror ('(priced_quote_period) primary key can not be changed.',10,1)
      rollback tran
      return
   end
end
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'priced_quote_period', NULL, NULL
GO
