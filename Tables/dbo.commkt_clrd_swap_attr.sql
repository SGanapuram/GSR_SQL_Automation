...
[status] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__commkt_cl__statu__29E1370A] DEFAULT ('A'),
...
[commkt_settlement_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__commkt_cl__commk__2BC97F7C] DEFAULT ('C'),
...
[long_short_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__commkt_cl__long___2DB1C7EE] DEFAULT ('L'),
[spread_qty_factor] [int] NOT NULL,
[trans_id] [int] NOT NULL,
[margin_type] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__commkt_cl__margi__2F9A1060] DEFAULT ('P')
) ON [PRIMARY]
GO
...
begin
   raiserror ('(commkt_clrd_swap_attr) The change needs to be attached with a new trans_id.',10,1)
   if @@trancount > 0 rollback tran
...
begin
   ...
   begin
      raiserror ('(commkt_clrd_swap_attr) primary key can not be changed.',10,1)
      if @@trancount > 0 rollback tran
...
return
GO
ALTER TABLE [dbo].[commkt_clrd_swap_attr] ADD CONSTRAINT [CK__commkt_cl__commk__2CBDA3B5] CHECK (([commkt_settlement_ind]='P' OR [commkt_settlement_ind]='C'))
GO
ALTER TABLE [dbo].[commkt_clrd_swap_attr] ADD CONSTRAINT [CK__commkt_cl__long___2EA5EC27] CHECK (([long_short_ind]='S' OR [long_short_ind]='L'))
GO
ALTER TABLE [dbo].[commkt_clrd_swap_attr] ADD CONSTRAINT [CK__commkt_cl__margi__308E3499] CHECK (([margin_type]='F' OR [margin_type]='P'))
GO
ALTER TABLE [dbo].[commkt_clrd_swap_attr] ADD CONSTRAINT [CK__commkt_cl__statu__2AD55B43] CHECK (([status]='I' OR [status]='A'))
GO
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'commkt_clrd_swap_attr', NULL, NULL
GO
