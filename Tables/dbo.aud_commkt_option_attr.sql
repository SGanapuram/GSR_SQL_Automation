CREATE TABLE [dbo].[aud_commkt_option_attr]
(
...
[margin_type] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__aud_commk__margi__6B4FD30B] DEFAULT ('P')
) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [aud_commkt_option_attr] ON [dbo].[aud_commkt_option_attr] ([commkt_key], [trans_id], [resp_trans_id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [aud_commkt_option_attr_idx1] ON [dbo].[aud_commkt_option_attr] ([trans_id]) ON [PRIMARY]
GO
GRANT DELETE ON  [dbo].[aud_commkt_option_attr] TO [ictspurge]
GO
GRANT SELECT ON  [dbo].[aud_commkt_option_attr] TO [ictspurge]
GO
GRANT UPDATE ON  [dbo].[aud_commkt_option_attr] TO [ictspurge]
GO
GRANT INSERT ON  [dbo].[aud_commkt_option_attr] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[aud_commkt_option_attr] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'aud_commkt_option_attr', NULL, NULL
GO
