CREATE TABLE [dbo].[archive_pl_history]
(
...
GO
ALTER TABLE [dbo].[archive_pl_history] ADD CONSTRAINT [archive_pl_history_pk] PRIMARY KEY CLUSTERED  ([pl_asof_date], [pl_record_key], [pl_owner_code], [pl_type]) ON [PRIMARY]
GO
GRANT DELETE ON  [dbo].[archive_pl_history] TO [next_usr]
GO
GRANT INSERT ON  [dbo].[archive_pl_history] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[archive_pl_history] TO [next_usr]
GO
GRANT UPDATE ON  [dbo].[archive_pl_history] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'archive_pl_history', NULL, NULL
GO
