...
[archived_date] [datetime] NOT NULL CONSTRAINT [DF__external___archi__4AD81681] DEFAULT (getdate())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'external_comment_archive', NULL, NULL
GO
