...
GO
ALTER TABLE [dbo].[uic_report_modification] ADD CONSTRAINT [CK__uic_repor__opera__28C2F59F] CHECK (([operation_type]='D' OR [operation_type]='U' OR [operation_type]='I'))
GO
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'uic_report_modification', NULL, NULL
GO
