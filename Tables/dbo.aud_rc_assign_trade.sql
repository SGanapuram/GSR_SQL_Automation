...
GO
GRANT DELETE ON  [dbo].[aud_rc_assign_trade] TO [ictspurge]
GO
GRANT SELECT ON  [dbo].[aud_rc_assign_trade] TO [ictspurge]
GO
GRANT UPDATE ON  [dbo].[aud_rc_assign_trade] TO [ictspurge]
GO
GRANT INSERT ON  [dbo].[aud_rc_assign_trade] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[aud_rc_assign_trade] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'aud_rc_assign_trade', NULL, NULL
GO
