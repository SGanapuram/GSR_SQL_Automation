...
GO
CREATE CLUSTERED INDEX [aud_cost] ON [dbo].[aud_cost] ([cost_amt], [cost_pay_rec_ind], [pos_group_num], [cost_owner_code], [cost_owner_key1]) WITH (DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [aud_cost_idx5] ON [dbo].[aud_cost] ([cost_num], [port_num], [cost_code], [resp_trans_id]) WITH (DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [aud_cost_idx6] ON [dbo].[aud_cost] ([cost_num], [port_num], [cost_prim_sec_ind], [resp_trans_id]) WITH (DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [aud_cost_idx] ON [dbo].[aud_cost] ([cost_num], [trans_id], [resp_trans_id]) WITH (DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [aud_cost_idx3] ON [dbo].[aud_cost] ([cost_owner_code], [cost_owner_key1], [cost_owner_key2], [cost_owner_key3], [cost_owner_key4]) WITH (DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [aud_cost_idx2] ON [dbo].[aud_cost] ([cost_owner_key6], [cost_owner_key7], [cost_owner_key8]) WITH (DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [aud_cost_idx4] ON [dbo].[aud_cost] ([parent_cost_num]) WITH (DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [aud_cost_idx1] ON [dbo].[aud_cost] ([trans_id]) WITH (DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
