...
[value_type_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__portfolio__value__672A3C6C] DEFAULT ('S'),
[value_attribute] [varchar] (60) COLLATE SQL_Latin1_General_CP1_CS_AS NULL,
[tag_status] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__portfolio__tag_s__691284DE] DEFAULT ('A'),
[tag_required_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__portfolio__tag_r__6AFACD50] DEFAULT ('N'),
...
begin
   raiserror('(portfolio_tag_definition) The change needs to be attached with a new trans_id', 16, 1)
   rollback tran
   return
end
...
begin
   raiserror('(portfolio_tag_definition) new trans_id must not be older than current trans_id.', 16, 1)
   rollback tran
   return
end
...
begin
   ...
   begin
      raiserror('(portfolio_tag_definition) primary key can not be changed.', 16, 1)
      rollback tran
      return
   end
end
...
return
GO
ALTER TABLE [dbo].[portfolio_tag_definition] ADD CONSTRAINT [CK__portfolio__tag_r__6BEEF189] CHECK (([tag_required_ind]='N' OR [tag_required_ind]='Y'))
GO
ALTER TABLE [dbo].[portfolio_tag_definition] ADD CONSTRAINT [CK__portfolio__tag_s__6A06A917] CHECK (([tag_status]='S' OR [tag_status]='I' OR [tag_status]='A'))
GO
ALTER TABLE [dbo].[portfolio_tag_definition] ADD CONSTRAINT [CK__portfolio__value__681E60A5] CHECK (([value_type_ind]='D' OR [value_type_ind]='N' OR [value_type_ind]='S'))
GO
