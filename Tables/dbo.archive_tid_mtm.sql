...
[trade_modified_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NULL CONSTRAINT [DF__archive_t__trade__5224328E] DEFAULT ('N'),
[commkt_key] [int] NULL,
[pos_num] [int] NULL,
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'archive_tid_mtm', NULL, NULL
GO
