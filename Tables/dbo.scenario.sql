...
[scenario_type] [varchar] (12) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [df_scenario_scenario_type] DEFAULT ('ASSET'),
[qty] [numeric] (20, 8) NULL,
[qty_uom_code] [char] (4) COLLATE SQL_Latin1_General_CP1_CS_AS NULL,
[qty_periodicity] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NULL CONSTRAINT [df_scenario_qty_periodicity] DEFAULT ('D'),
...
begin
   raiserror ('(scenario) The change needs to be attached with a new trans_id.',16,1)
   if @@trancount > 0 rollback tran
...
begin
   ...
   begin
      raiserror ('(scenario) primary key can not be changed.',16,1)
      if @@trancount > 0 rollback tran
...
return
GO
ALTER TABLE [dbo].[scenario] ADD CONSTRAINT [chk_scenario_qty_periodicity] CHECK (([qty_periodicity]='L' OR [qty_periodicity]='D'))
GO
ALTER TABLE [dbo].[scenario] ADD CONSTRAINT [chk_scenario_scenario_type] CHECK (([scenario_type]='OPPORTUNITY' OR [scenario_type]='ASSET'))
GO
