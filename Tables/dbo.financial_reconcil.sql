...
GO
ALTER TABLE [dbo].[financial_reconcil] ADD CONSTRAINT [CK__financial__sourc__22951AFD] CHECK (([source_feed]='F' OR [source_feed]='P'))
GO
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'financial_reconcil', NULL, NULL
GO
