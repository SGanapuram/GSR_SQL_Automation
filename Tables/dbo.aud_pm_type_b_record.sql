...
GO
GRANT DELETE ON  [dbo].[aud_pm_type_b_record] TO [ictspurge]
GO
GRANT SELECT ON  [dbo].[aud_pm_type_b_record] TO [ictspurge]
GO
GRANT UPDATE ON  [dbo].[aud_pm_type_b_record] TO [ictspurge]
GO
GRANT INSERT ON  [dbo].[aud_pm_type_b_record] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[aud_pm_type_b_record] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'aud_pm_type_b_record', NULL, NULL
GO
