...
begin
   raiserror ('(risk_value_history) The change needs to be attached with a new trans_id',10,1)
...
begin
   ...
   begin
      raiserror ('(risk_value_history) primary key can not be changed.',10,1)
      if @@trancount > 0 rollback tran
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'risk_value_history', NULL, NULL
GO
