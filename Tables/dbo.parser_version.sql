...
[has_header_row] [bit] NOT NULL CONSTRAINT [df_parser_version_has_header_row] DEFAULT ((1)),
[has_specs] [bit] NOT NULL CONSTRAINT [df_parser_version_has_specs] DEFAULT ((1)),
[parser_version] [int] NOT NULL,
[trans_id] [int] NOT NULL,
[is_active] [bit] NOT NULL CONSTRAINT [df_parser_version_is_active] DEFAULT ((1))
) ON [PRIMARY]
GO
