...
[lc_netting_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__aud_lc__lc_netti__151102AD] DEFAULT ('N'),
[lc_template_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__aud_lc__lc_templ__160526E6] DEFAULT ('N'),
[other_lcs_rel_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__aud_lc__other_lc__16F94B1F] DEFAULT ('N'),
...
GO
GRANT DELETE ON  [dbo].[aud_lc] TO [ictspurge]
GO
GRANT SELECT ON  [dbo].[aud_lc] TO [ictspurge]
GO
GRANT UPDATE ON  [dbo].[aud_lc] TO [ictspurge]
GO
GRANT INSERT ON  [dbo].[aud_lc] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[aud_lc] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'aud_lc', NULL, NULL
GO
