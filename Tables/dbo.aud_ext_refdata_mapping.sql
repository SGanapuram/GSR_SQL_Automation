CREATE TABLE [dbo].[aud_ext_refdata_mapping]
(
[oid] [int] NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [aud_ext_refdata_mapping] ON [dbo].[aud_ext_refdata_mapping] ([oid], [trans_id], [resp_trans_id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [aud_ext_refdata_mapping_idx1] ON [dbo].[aud_ext_refdata_mapping] ([trans_id]) ON [PRIMARY]
GO
GRANT INSERT ON  [dbo].[aud_ext_refdata_mapping] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[aud_ext_refdata_mapping] TO [next_usr]
GO
