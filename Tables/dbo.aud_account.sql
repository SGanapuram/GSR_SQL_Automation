...
[allows_netout] [bit] NOT NULL CONSTRAINT [DF__aud_accou__allow__072CF7AA] DEFAULT ((0)),
[allows_bookout] [bit] NOT NULL CONSTRAINT [DF__aud_accou__allow__08211BE3] DEFAULT ((0)),
...
GO
GRANT DELETE ON  [dbo].[aud_account] TO [ictspurge]
GO
GRANT SELECT ON  [dbo].[aud_account] TO [ictspurge]
GO
GRANT UPDATE ON  [dbo].[aud_account] TO [ictspurge]
GO
GRANT INSERT ON  [dbo].[aud_account] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[aud_account] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'aud_account', NULL, NULL
GO
