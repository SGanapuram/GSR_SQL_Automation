CREATE TABLE [dbo].[archive_ti_mtm]
(
...
GO
ALTER TABLE [dbo].[archive_ti_mtm] ADD CONSTRAINT [archive_ti_mtm_pk] PRIMARY KEY CLUSTERED  ([trade_num], [order_num], [item_num], [mtm_pl_asof_date]) ON [PRIMARY]
GO
GRANT DELETE ON  [dbo].[archive_ti_mtm] TO [next_usr]
GO
GRANT INSERT ON  [dbo].[archive_ti_mtm] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[archive_ti_mtm] TO [next_usr]
GO
GRANT UPDATE ON  [dbo].[archive_ti_mtm] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'archive_ti_mtm', NULL, NULL
GO
