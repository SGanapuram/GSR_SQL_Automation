...
create trigger [dbo].[pricing_rule_deltrg]                                                                                                                       
on [dbo].[pricing_rule]                                                                                                                                          
for delete                                                                                                                                                
as                                                                                                                                                        
...
begin                                                                                                                                                     
   set @errmsg = '(pricing_rule) Failed to obtain a valid responsible trans_id.'                                                                        
   if exists (select 1                                                                                                                                    
              from master.dbo.sysprocesses (nolock)                                                                                                       
              where spid = @@spid and                                                                                                                     
...
select                                                                                                                                                    
	...
	d.max_content,
	d.min_content,
	d.rule_direction_ind,
	d.qp_decl_option_ind,
	d.trans_id,
	@atrans_id,
	d.parent_pricing_rule_oid
from deleted d                                                                                                                                            
...
create trigger [dbo].[pricing_rule_instrg]                                                                   
on [dbo].[pricing_rule]                                                                                      
for insert                                                                                               
as                                                                                                       
declare @num_rows       int,                                                                             
...
create trigger [dbo].[pricing_rule_updtrg]                                                                                       
on [dbo].[pricing_rule]                                                                                                          
for update                                                                                                                   
as                                                                                                                           
declare @num_rows         int,                                                                                               
...
begin                                                                                                                        
   raiserror ('(pricing_rule) The change needs to be attached with a new trans_id',16,1)                                   
   rollback tran                                                                                                             
   return                                                                                                                    
end                                                                                                                          
...
begin                                                                                                                        
   ...
   begin                                                                                                                     
      set @errmsg = '(pricing_rule) New trans_id must be larger than original trans_id.'                                
...
if exists (select * from inserted i, deleted d                                                                               
           where i.trans_id < d.trans_id and                                                                                 
                 i.oid = d.oid)                                                                                             
begin                                                                                                                        
   raiserror ('(pricing_rule) new trans_id must not be older than current trans_id.',16,1)                                 
   rollback tran                                                                                                             
   return                                                                                                                    
end                                                                                                                          
...
begin                                                                                                                        
   ...
   begin                                                                                                                     
      raiserror ('(pricing_rule) primary key can not be changed.',16,1)                                                    
      rollback tran                                                                                                          
      return                                                                                                                 
   end                                                                                                                       
end                                                                                                                          
