...
[equiv_source_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NULL,
...
GO
CREATE NONCLUSTERED INDEX [aud_position_idx] ON [dbo].[aud_position] ([pos_num]) WITH (DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [aud_position] ON [dbo].[aud_position] ([pos_num], [trans_id], [resp_trans_id]) WITH (DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [aud_position_idx1] ON [dbo].[aud_position] ([trans_id]) WITH (DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
