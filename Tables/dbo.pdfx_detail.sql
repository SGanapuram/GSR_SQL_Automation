...
GO
GRANT DELETE ON  [dbo].[pdfx_detail] TO [next_usr]
GO
GRANT INSERT ON  [dbo].[pdfx_detail] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[pdfx_detail] TO [next_usr]
GO
GRANT UPDATE ON  [dbo].[pdfx_detail] TO [next_usr]
GO
