...
[fifo_open_qty] [float] NULL,
[fifo_open_qty_uom_code] [char] (4) COLLATE SQL_Latin1_General_CP1_CS_AS NULL,
[sec_fifo_open_qty] [float] NULL,
[sec_fifo_open_qty_uom_code] [char] (4) COLLATE SQL_Latin1_General_CP1_CS_AS NULL,
[inv_pricing_type] [char] (15) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [df_inventory_inv_pricing_type] DEFAULT (''),
[use_mtm] [bit] NULL
) ON [PRIMARY]
GO
