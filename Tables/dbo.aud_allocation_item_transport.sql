...
GO
GRANT DELETE ON  [dbo].[aud_allocation_item_transport] TO [ictspurge]
GO
GRANT SELECT ON  [dbo].[aud_allocation_item_transport] TO [ictspurge]
GO
GRANT UPDATE ON  [dbo].[aud_allocation_item_transport] TO [ictspurge]
GO
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'aud_allocation_item_transport', NULL, NULL
GO
