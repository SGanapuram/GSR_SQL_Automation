...
GO
GRANT DELETE ON  [dbo].[aud_allocation_type] TO [ictspurge]
GO
GRANT SELECT ON  [dbo].[aud_allocation_type] TO [ictspurge]
GO
GRANT UPDATE ON  [dbo].[aud_allocation_type] TO [ictspurge]
GO
GRANT INSERT ON  [dbo].[aud_allocation_type] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[aud_allocation_type] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'aud_allocation_type', NULL, NULL
GO
