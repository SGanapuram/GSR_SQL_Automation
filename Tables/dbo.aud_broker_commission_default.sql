...
GO
GRANT DELETE ON  [dbo].[aud_broker_commission_default] TO [ictspurge]
GO
GRANT SELECT ON  [dbo].[aud_broker_commission_default] TO [ictspurge]
GO
GRANT UPDATE ON  [dbo].[aud_broker_commission_default] TO [ictspurge]
GO
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'aud_broker_commission_default', NULL, NULL
GO
