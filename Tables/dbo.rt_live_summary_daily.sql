CREATE TABLE [dbo].[rt_live_summary_daily]
(
...
GO
ALTER TABLE [dbo].[rt_live_summary_daily] ADD CONSTRAINT [rt_live_summary_daily_pk] PRIMARY KEY CLUSTERED  ([ticket_num], [time_stamp]) ON [PRIMARY]
GO
GRANT DELETE ON  [dbo].[rt_live_summary_daily] TO [next_usr]
GO
GRANT INSERT ON  [dbo].[rt_live_summary_daily] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[rt_live_summary_daily] TO [next_usr]
GO
GRANT UPDATE ON  [dbo].[rt_live_summary_daily] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'rt_live_summary_daily', NULL, NULL
GO
