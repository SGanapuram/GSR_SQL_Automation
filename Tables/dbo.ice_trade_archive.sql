...
[archived_date] [datetime] NOT NULL CONSTRAINT [DF__ice_trade__archi__131DCD43] DEFAULT (getdate())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'ice_trade_archive', NULL, NULL
GO
