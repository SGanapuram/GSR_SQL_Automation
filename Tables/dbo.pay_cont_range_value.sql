...
create trigger [dbo].[pay_cont_range_value_deltrg]                                                                                                                       
on [dbo].[pay_cont_range_value]                                                                                                                                          
for delete                                                                                                                                                
as                                                                                                                                                        
...
begin                                                                                                                                                     
   set @errmsg = '(pay_cont_range_value) Failed to obtain a valid responsible trans_id.'                                                                        
   if exists (select 1                                                                                                                                    
              from master.dbo.sysprocesses (nolock)                                                                                                       
              where spid = @@spid and                                                                                                                     
...
insert dbo.aud_pay_cont_range_value                                                                                                                                  
   (
	oid,
	cp_formula_oid,
	price_rule_oid,
...
select                                                                                                                                                    
	...
	d.cp_formula_oid,
	d.price_rule_oid,
	d.pay_range_def_oid1,
	d.pay_range_def_oid2,
	d.percentage,
	d.deduction,
	d.application,
	d.trans_id,
...
declare @the_sequence       numeric(32, 0),                                                                                                               
   ...
   set @the_entity_name = 'PayContRangeValue'                                                                                                           
...
create trigger [dbo].[pay_cont_range_value_instrg]                                                                   
on [dbo].[pay_cont_range_value]                                                                                      
for insert                                                                                               
as                                                                                                       
declare @num_rows       int,                                                                             
...
create trigger [dbo].[pay_cont_range_value_updtrg]                                                                                       
on [dbo].[pay_cont_range_value]                                                                                                          
for update                                                                                                                   
as                                                                                                                           
declare @num_rows         int,                                                                                               
...
begin                                                                                                                        
   raiserror ('(pay_cont_range_value) The change needs to be attached with a new trans_id',16,1)                                   
   rollback tran                                                                                                             
   return                                                                                                                    
end                                                                                                                          
...
begin                                                                                                                        
   ...
   begin                                                                                                                     
      set @errmsg = '(pay_cont_range_value) New trans_id must be larger than original trans_id.'                                
...
if exists (select * from inserted i, deleted d                                                                               
           where i.trans_id < d.trans_id and                                                                                 
                 i.oid = d.oid)                                                                                             
begin                                                                                                                        
   raiserror ('(pay_cont_range_value) new trans_id must not be older than current trans_id.',16,1)                                 
   rollback tran                                                                                                             
   return                                                                                                                    
end                                                                                                                          
...
begin                                                                                                                        
   ...
   begin                                                                                                                     
      raiserror ('(pay_cont_range_value) primary key can not be changed.',16,1)                                                    
      rollback tran                                                                                                          
      return                                                                                                                 
   end                                                                                                                       
end                                                                                                                          
