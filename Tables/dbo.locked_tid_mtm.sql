CREATE TABLE [dbo].[locked_tid_mtm]
(
...
[trade_modified_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NULL CONSTRAINT [DF__locked_ti__trade__4B2D1C3C] DEFAULT ('N'),
[commkt_key] [int] NULL,
[pos_num] [int] NULL,
...
GO
ALTER TABLE [dbo].[locked_tid_mtm] ADD CONSTRAINT [locked_tid_mtm_pk] PRIMARY KEY CLUSTERED  ([dist_num]) ON [PRIMARY]
GO
GRANT DELETE ON  [dbo].[locked_tid_mtm] TO [next_usr]
GO
GRANT INSERT ON  [dbo].[locked_tid_mtm] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[locked_tid_mtm] TO [next_usr]
GO
GRANT UPDATE ON  [dbo].[locked_tid_mtm] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'locked_tid_mtm', NULL, NULL
GO
