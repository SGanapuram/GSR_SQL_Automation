...
[archived_date] [datetime] NOT NULL CONSTRAINT [DF__exch_tool__archi__34E8D562] DEFAULT (getdate())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'exch_tools_trade_archive', NULL, NULL
GO
