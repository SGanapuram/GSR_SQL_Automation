...
create trigger [dbo].[penalty_rule_content_basis_deltrg]                                                                                                                       
on [dbo].[penalty_rule_content_basis]                                                                                                                                          
for delete                                                                                                                                                
as                                                                                                                                                        
...
begin                                                                                                                                                     
   set @errmsg = '(penalty_rule_content_basis) Failed to obtain a valid responsible trans_id.'                                                                        
   if exists (select 1                                                                                                                                    
              from master.dbo.sysprocesses (nolock)                                                                                                       
              where spid = @@spid and                                                                                                                     
...
insert dbo.aud_penalty_rule_content_basis                                                                                                                                  
   (
	oid,
	cp_formula_oid,
	price_rule_oid,
...
declare @the_sequence       numeric(32, 0),                                                                                                               
   ...
   set @the_entity_name = 'PenaltyRuleContentBasis'                                                                                                           
...
create trigger [dbo].[penalty_rule_content_basis_instrg]                                                                   
on [dbo].[penalty_rule_content_basis]                                                                                      
for insert                                                                                               
as                                                                                                       
declare @num_rows       int,                                                                             
...
create trigger [dbo].[penalty_rule_content_basis_updtrg]                                                                                       
on [dbo].[penalty_rule_content_basis]                                                                                                          
for update                                                                                                                   
as                                                                                                                           
declare @num_rows         int,                                                                                               
...
begin                                                                                                                        
   raiserror ('(penalty_rule_content_basis) The change needs to be attached with a new trans_id',16,1)                                   
   rollback tran                                                                                                             
   return                                                                                                                    
end                                                                                                                          
...
begin                                                                                                                        
   ...
   begin                                                                                                                     
      set @errmsg = '(penalty_rule_content_basis) New trans_id must be larger than original trans_id.'                                
...
if exists (select * from inserted i, deleted d                                                                               
           where i.trans_id < d.trans_id and                                                                                 
                 i.oid = d.oid)                                                                                             
begin                                                                                                                        
   raiserror ('(penalty_rule_content_basis) new trans_id must not be older than current trans_id.',16,1)                                 
   rollback tran                                                                                                             
   return                                                                                                                    
end                                                                                                                          
...
begin                                                                                                                        
   ...
   begin                                                                                                                     
      raiserror ('(penalty_rule_content_basis) primary key can not be changed.',16,1)                                                    
      rollback tran                                                                                                          
      return                                                                                                                 
   end                                                                                                                       
end                                                                                                                          
