...
begin  
   ...
   begin  
      raiserror ('(uur_tool_info) primary key can not be changed.'  ,10,1)
...
GO
GRANT INSERT ON  [dbo].[uur_tool_info] TO [uurt]
GO
GRANT SELECT ON  [dbo].[uur_tool_info] TO [uurt]
GO
GRANT UPDATE ON  [dbo].[uur_tool_info] TO [uurt]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'uur_tool_info', NULL, NULL
GO
