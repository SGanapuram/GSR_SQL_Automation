...
[mca_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [df_acct_bookcomp_collatera_mca_ind] DEFAULT ('N'),
[mca_eff_date] [datetime] NULL,
[net_pay_agree_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [df_acct_bookcomp_collatera_net_pay_agree_ind] DEFAULT ('N'),
[net_out_agree_eff_date] [datetime] NULL,
[net_out_cont_num] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CS_AS NULL,
[isda_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [df_acct_bookcomp_collatera_isda_ind] DEFAULT ('N'),
...
begin
   raiserror ('(acct_bookcomp_collatera) The change needs to be attached with a new trans_id.',16,1)
   if @@trancount > 0 rollback tran
...
begin
   ...
   begin
      raiserror ('(acct_bookcomp_collatera) primary key can not be changed.',16,1)
      if @@trancount > 0 rollback tran
...
return
GO
ALTER TABLE [dbo].[acct_bookcomp_collatera] ADD CONSTRAINT [chk_acct_bookcomp_collatera_isda_ind] CHECK (([isda_ind]='N' OR [isda_ind]='Y'))
GO
ALTER TABLE [dbo].[acct_bookcomp_collatera] ADD CONSTRAINT [chk_acct_bookcomp_collatera_mca_ind] CHECK (([mca_ind]='N' OR [mca_ind]='Y'))
GO
ALTER TABLE [dbo].[acct_bookcomp_collatera] ADD CONSTRAINT [chk_acct_bookcomp_collatera_net_pay_agree_ind] CHECK (([net_pay_agree_ind]='N' OR [net_pay_agree_ind]='Y'))
GO
