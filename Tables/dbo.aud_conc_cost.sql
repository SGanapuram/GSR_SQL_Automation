...
GO
CREATE NONCLUSTERED INDEX [aud_conc_cost] ON [dbo].[aud_conc_cost] ([oid], [trans_id], [resp_trans_id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [aud_conc_cost_idx1] ON [dbo].[aud_conc_cost] ([trans_id]) ON [PRIMARY]
GO
