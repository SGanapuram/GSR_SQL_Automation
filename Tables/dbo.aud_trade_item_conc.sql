CREATE TABLE [dbo].[aud_trade_item_conc]
(
...
GO
CREATE NONCLUSTERED INDEX [aud_trade_item_conc] ON [dbo].[aud_trade_item_conc] ([trade_num], [order_num], [item_num], [trans_id], [resp_trans_id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [aud_trade_item_conc_idx1] ON [dbo].[aud_trade_item_conc] ([trans_id]) ON [PRIMARY]
GO
GRANT INSERT ON  [dbo].[aud_trade_item_conc] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[aud_trade_item_conc] TO [next_usr]
GO
