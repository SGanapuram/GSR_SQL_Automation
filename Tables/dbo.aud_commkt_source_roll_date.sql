...
GO
GRANT DELETE ON  [dbo].[aud_commkt_source_roll_date] TO [ictspurge]
GO
GRANT SELECT ON  [dbo].[aud_commkt_source_roll_date] TO [ictspurge]
GO
GRANT UPDATE ON  [dbo].[aud_commkt_source_roll_date] TO [ictspurge]
GO
GRANT INSERT ON  [dbo].[aud_commkt_source_roll_date] TO [next_usr]
GO
GRANT SELECT ON  [dbo].[aud_commkt_source_roll_date] TO [next_usr]
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'aud_commkt_source_roll_date', NULL, NULL
GO
