...
[lc_exp_imp_ind] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__lc_bankfe__lc_ex__7740A8A4] DEFAULT ('I'),
[book_comp_num] [int] NOT NULL,
[issuing_bank] [int] NOT NULL,
[lc_bankfee_type] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__lc_bankfe__lc_ba__7928F116] DEFAULT ('F'),
[lc_bankfee_amt] [decimal] (20, 8) NOT NULL,
[lc_bankfee_curr_code] [char] (8) COLLATE SQL_Latin1_General_CP1_CS_AS NULL,
[lc_bankfee_status] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [DF__lc_bankfe__lc_ba__7B113988] DEFAULT ('A'),
...
begin
   raiserror ('(lc_bankfee_refdata) The change needs to be attached with a new trans_id.',10,1)
   if @@trancount > 0 rollback tran
...
begin
   ...
   begin
      raiserror ('(lc_bankfee_refdata) primary key can not be changed.',10,1)
      if @@trancount > 0 rollback tran
...
return
GO
ALTER TABLE [dbo].[lc_bankfee_refdata] ADD CONSTRAINT [CK__lc_bankfe__lc_ba__7C055DC1] CHECK (([lc_bankfee_status]='I' OR [lc_bankfee_status]='A'))
GO
ALTER TABLE [dbo].[lc_bankfee_refdata] ADD CONSTRAINT [CK__lc_bankfe__lc_ba__7A1D154F] CHECK (([lc_bankfee_type]='R' OR [lc_bankfee_type]='F'))
GO
ALTER TABLE [dbo].[lc_bankfee_refdata] ADD CONSTRAINT [CK__lc_bankfe__lc_ex__7834CCDD] CHECK (([lc_exp_imp_ind]='I' OR [lc_exp_imp_ind]='E'))
GO
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'lc_bankfee_refdata', NULL, NULL
GO
