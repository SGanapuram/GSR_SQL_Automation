...
create trigger [dbo].[rc_rule_escalator_price_base_deltrg]                                                                                                                       
on [dbo].[rc_rule_escalator_price_base]                                                                                                                                          
for delete                                                                                                                                                
as                                                                                                                                                        
...
begin                                                                                                                                                     
   set @errmsg = '(rc_rule_escalator_price_base) Failed to obtain a valid responsible trans_id.'                                                                        
   if exists (select 1                                                                                                                                    
              from master.dbo.sysprocesses (nolock)                                                                                                       
              where spid = @@spid and                                                                                                                     
...
insert dbo.aud_rc_rule_escalator_price_base                                                                                                                                  
   (                                                                                                                                                      
	oid,
	cp_formula_oid,
	price_rule_oid,
...
declare @the_sequence       numeric(32, 0),                                                                                                               
   ...
   set @the_entity_name = 'RcRuleEscalatorPriceBase'                                                                                                           
...
create trigger [dbo].[rc_rule_escalator_price_base_instrg]                                                                   
on [dbo].[rc_rule_escalator_price_base]                                                                                      
for insert                                                                                               
as                                                                                                       
declare @num_rows       int,                                                                             
...
create trigger [dbo].[rc_rule_escalator_price_base_updtrg]                                                                                       
on [dbo].[rc_rule_escalator_price_base]                                                                                                          
for update                                                                                                                   
as                                                                                                                           
declare @num_rows         int,                                                                                               
...
begin                                                                                                                        
   raiserror ('(rc_rule_escalator_price_base) The change needs to be attached with a new trans_id',16,1)                                   
   rollback tran                                                                                                             
   return                                                                                                                    
end                                                                                                                          
...
begin                                                                                                                        
   ...
   begin                                                                                                                     
      set @errmsg = '(rc_rule_escalator_price_base) New trans_id must be larger than original trans_id.'                                
...
if exists (select * from inserted i, deleted d                                                                               
           where i.trans_id < d.trans_id and                                                                                 
                 i.oid = d.oid)                                                                                             
begin                                                                                                                        
   raiserror ('(rc_rule_escalator_price_base) new trans_id must not be older than current trans_id.',16,1)                                 
   rollback tran                                                                                                             
   return                                                                                                                    
end                                                                                                                          
...
begin                                                                                                                        
   ...
   begin                                                                                                                     
      raiserror ('(rc_rule_escalator_price_base) primary key can not be changed.',16,1)                                                    
      rollback tran                                                                                                          
      return                                                                                                                 
   end                                                                                                                       
end                                                                                                                          
