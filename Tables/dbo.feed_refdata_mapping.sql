...
begin
   raiserror ('(feed_refdata_mapping) The change needs to be attached with a new trans_id.',10,1)
...
begin
   ...
   begin
      raiserror ('(feed_refdata_mapping) primary key can not be changed.',10,1)
      if @@trancount > 0 rollback tran
...
GO
EXEC sp_addextendedproperty N'SymphonyProduct', N'OIL', 'SCHEMA', N'dbo', 'TABLE', N'feed_refdata_mapping', NULL, NULL
GO
