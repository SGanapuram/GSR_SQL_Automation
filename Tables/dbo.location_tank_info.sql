...
[status] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [df_location_tank_info_status] DEFAULT ('A'),
[excise_warehouse_loc_ind] [bit] NOT NULL CONSTRAINT [df_location_tank_info_excise_warehouse_loc_ind] DEFAULT ((0)),
[bonded_warehouse_loc_ind] [bit] NOT NULL CONSTRAINT [df_location_tank_info_bonded_warehouse_loc_ind] DEFAULT ((0)),
...
[location_tank_info_type] [char] (1) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL CONSTRAINT [df_location_tank_info_location_tank_info_type] DEFAULT ('T'),
[confirmation_status] [bit] NOT NULL CONSTRAINT [df_location_tank_info_confirmation_status] DEFAULT ((0)),
[first_purchaser_ind] [bit] NOT NULL CONSTRAINT [df_location_tank_info_first_purchaser_ind] DEFAULT ((0)),
...
begin
   raiserror ('(location_tank_info) The change needs to be attached with a new trans_id.',16,1)
   if @@trancount > 0 rollback tran
...
begin
   raiserror ('(location_tank_info) new trans_id must not be older than current trans_id.',16,1)
   if @@trancount > 0 rollback tran
...
begin
   ...
   begin
      raiserror ('(location_tank_info) primary key can not be changed.',16,1)
      if @@trancount > 0 rollback tran
...
return
GO
ALTER TABLE [dbo].[location_tank_info] ADD CONSTRAINT [chk_location_tank_info_location_tank_info_type] CHECK (([location_tank_info_type]='T' OR [location_tank_info_type]='L'))
GO
ALTER TABLE [dbo].[location_tank_info] ADD CONSTRAINT [chk_location_tank_info_status] CHECK (([status]='N' OR [status]='I' OR [status]='A'))
GO
